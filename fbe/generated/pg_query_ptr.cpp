...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const Node& value)
{
    ...
    switch (value.index()) {
        case 0:
            stream<< "{Alias*}";
            stream << "ptr of other struct: " << (std::get<0>(value) == nullptr ? "nullptr" : "true");
        ...
        case 3:
            stream<< "{Expr*}";
            stream << "ptr of other struct: " << (std::get<3>(value) == nullptr ? "nullptr" : "true");
            if (std::get<3>(value) != nullptr)
            {
        ...
        case 6:
            stream<< "{Aggref*}";
            stream << "ptr of other struct: " << (std::get<6>(value) == nullptr ? "nullptr" : "true");
            if (std::get<6>(value) != nullptr)
            {
                stream << "->" << *std::get<6>(value);
            }
            break;
        case 7:
            stream<< "{GroupingFunc*}";
            stream << "ptr of other struct: " << (std::get<7>(value) == nullptr ? "nullptr" : "true");
            if (std::get<7>(value) != nullptr)
            {
                stream << "->" << *std::get<7>(value);
            }
            break;
        case 8:
            stream<< "{WindowFunc*}";
            stream << "ptr of other struct: " << (std::get<8>(value) == nullptr ? "nullptr" : "true");
            if (std::get<8>(value) != nullptr)
            {
                stream << "->" << *std::get<8>(value);
            }
            break;
        case 9:
            stream<< "{SubscriptingRef*}";
            stream << "ptr of other struct: " << (std::get<9>(value) == nullptr ? "nullptr" : "true");
            if (std::get<9>(value) != nullptr)
            {
                stream << "->" << *std::get<9>(value);
            }
            break;
        case 10:
            stream<< "{FuncExpr*}";
            stream << "ptr of other struct: " << (std::get<10>(value) == nullptr ? "nullptr" : "true");
            if (std::get<10>(value) != nullptr)
            {
                stream << "->" << *std::get<10>(value);
            }
            break;
        case 11:
            stream<< "{NamedArgExpr*}";
            stream << "ptr of other struct: " << (std::get<11>(value) == nullptr ? "nullptr" : "true");
            if (std::get<11>(value) != nullptr)
            {
        ...
        case 12:
            stream<< "{OpExpr*}";
            stream << "ptr of other struct: " << (std::get<12>(value) == nullptr ? "nullptr" : "true");
            if (std::get<12>(value) != nullptr)
            {
        ...
        case 13:
            stream<< "{DistinctExpr*}";
            stream << "ptr of other struct: " << (std::get<13>(value) == nullptr ? "nullptr" : "true");
            if (std::get<13>(value) != nullptr)
            {
        ...
        case 14:
            stream<< "{NullIfExpr*}";
            stream << "ptr of other struct: " << (std::get<14>(value) == nullptr ? "nullptr" : "true");
            if (std::get<14>(value) != nullptr)
            {
        ...
        case 15:
            ...
            stream << "ptr of other struct: " << (std::get<15>(value) == nullptr ? "nullptr" : "true");
            if (std::get<15>(value) != nullptr)
            {
                stream << "->" << *std::get<15>(value);
            }
            break;
        case 16:
            stream<< "{BoolExpr*}";
            stream << "ptr of other struct: " << (std::get<16>(value) == nullptr ? "nullptr" : "true");
            if (std::get<16>(value) != nullptr)
            {
                stream << "->" << *std::get<16>(value);
            }
            break;
        case 17:
            stream<< "{SubLink*}";
            stream << "ptr of other struct: " << (std::get<17>(value) == nullptr ? "nullptr" : "true");
            if (std::get<17>(value) != nullptr)
            {
                stream << "->" << *std::get<17>(value);
            }
            break;
        case 18:
            stream<< "{SubPlan*}";
            stream << "ptr of other struct: " << (std::get<18>(value) == nullptr ? "nullptr" : "true");
            if (std::get<18>(value) != nullptr)
            {
                stream << "->" << *std::get<18>(value);
            }
            break;
        case 19:
            stream<< "{AlternativeSubPlan*}";
            stream << "ptr of other struct: " << (std::get<19>(value) == nullptr ? "nullptr" : "true");
            if (std::get<19>(value) != nullptr)
            {
                stream << "->" << *std::get<19>(value);
            }
            break;
        case 20:
            stream<< "{FieldSelect*}";
            stream << "ptr of other struct: " << (std::get<20>(value) == nullptr ? "nullptr" : "true");
            if (std::get<20>(value) != nullptr)
            {
                stream << "->" << *std::get<20>(value);
            }
            break;
        case 21:
            stream<< "{FieldStore*}";
            stream << "ptr of other struct: " << (std::get<21>(value) == nullptr ? "nullptr" : "true");
            if (std::get<21>(value) != nullptr)
            {
                stream << "->" << *std::get<21>(value);
            }
            break;
        case 22:
            stream<< "{RelabelType*}";
            stream << "ptr of other struct: " << (std::get<22>(value) == nullptr ? "nullptr" : "true");
            if (std::get<22>(value) != nullptr)
            {
                stream << "->" << *std::get<22>(value);
            }
            break;
        case 23:
            stream<< "{CoerceViaIO*}";
            stream << "ptr of other struct: " << (std::get<23>(value) == nullptr ? "nullptr" : "true");
            if (std::get<23>(value) != nullptr)
            {
                stream << "->" << *std::get<23>(value);
            }
            break;
        case 24:
            stream<< "{ArrayCoerceExpr*}";
            stream << "ptr of other struct: " << (std::get<24>(value) == nullptr ? "nullptr" : "true");
            if (std::get<24>(value) != nullptr)
            {
                stream << "->" << *std::get<24>(value);
            }
            break;
        case 25:
            stream<< "{ConvertRowtypeExpr*}";
            stream << "ptr of other struct: " << (std::get<25>(value) == nullptr ? "nullptr" : "true");
            if (std::get<25>(value) != nullptr)
            {
                stream << "->" << *std::get<25>(value);
            }
            break;
        case 26:
            stream<< "{CollateExpr*}";
            stream << "ptr of other struct: " << (std::get<26>(value) == nullptr ? "nullptr" : "true");
            if (std::get<26>(value) != nullptr)
            {
                stream << "->" << *std::get<26>(value);
            }
            break;
        case 27:
            stream<< "{CaseExpr*}";
            stream << "ptr of other struct: " << (std::get<27>(value) == nullptr ? "nullptr" : "true");
            if (std::get<27>(value) != nullptr)
            {
                stream << "->" << *std::get<27>(value);
            }
            break;
        case 28:
            stream<< "{CaseWhen*}";
            stream << "ptr of other struct: " << (std::get<28>(value) == nullptr ? "nullptr" : "true");
            if (std::get<28>(value) != nullptr)
            {
                stream << "->" << *std::get<28>(value);
            }
            break;
        case 29:
            stream<< "{CaseTestExpr*}";
            stream << "ptr of other struct: " << (std::get<29>(value) == nullptr ? "nullptr" : "true");
            if (std::get<29>(value) != nullptr)
            {
                stream << "->" << *std::get<29>(value);
            }
            break;
        case 30:
            stream<< "{ArrayExpr*}";
            stream << "ptr of other struct: " << (std::get<30>(value) == nullptr ? "nullptr" : "true");
            if (std::get<30>(value) != nullptr)
            {
                stream << "->" << *std::get<30>(value);
            }
            break;
        case 31:
            stream<< "{RowExpr*}";
            stream << "ptr of other struct: " << (std::get<31>(value) == nullptr ? "nullptr" : "true");
            if (std::get<31>(value) != nullptr)
            {
                stream << "->" << *std::get<31>(value);
            }
            break;
        case 32:
            stream<< "{RowCompareExpr*}";
            stream << "ptr of other struct: " << (std::get<32>(value) == nullptr ? "nullptr" : "true");
            if (std::get<32>(value) != nullptr)
            {
                stream << "->" << *std::get<32>(value);
            }
            break;
        case 33:
            stream<< "{CoalesceExpr*}";
            stream << "ptr of other struct: " << (std::get<33>(value) == nullptr ? "nullptr" : "true");
            if (std::get<33>(value) != nullptr)
            {
                stream << "->" << *std::get<33>(value);
            }
            break;
        case 34:
            stream<< "{MinMaxExpr*}";
            stream << "ptr of other struct: " << (std::get<34>(value) == nullptr ? "nullptr" : "true");
            if (std::get<34>(value) != nullptr)
            {
                stream << "->" << *std::get<34>(value);
            }
            break;
        case 35:
            stream<< "{SQLValueFunction*}";
            stream << "ptr of other struct: " << (std::get<35>(value) == nullptr ? "nullptr" : "true");
            if (std::get<35>(value) != nullptr)
            {
                stream << "->" << *std::get<35>(value);
            }
            break;
        case 36:
            stream<< "{XmlExpr*}";
            stream << "ptr of other struct: " << (std::get<36>(value) == nullptr ? "nullptr" : "true");
            if (std::get<36>(value) != nullptr)
            {
                stream << "->" << *std::get<36>(value);
            }
            break;
        case 37:
            stream<< "{NullTest*}";
            stream << "ptr of other struct: " << (std::get<37>(value) == nullptr ? "nullptr" : "true");
            if (std::get<37>(value) != nullptr)
            {
                stream << "->" << *std::get<37>(value);
            }
            break;
        case 38:
            stream<< "{BooleanTest*}";
            stream << "ptr of other struct: " << (std::get<38>(value) == nullptr ? "nullptr" : "true");
            if (std::get<38>(value) != nullptr)
            {
                stream << "->" << *std::get<38>(value);
            }
            break;
        case 39:
            stream<< "{CoerceToDomain*}";
            stream << "ptr of other struct: " << (std::get<39>(value) == nullptr ? "nullptr" : "true");
            if (std::get<39>(value) != nullptr)
            {
                stream << "->" << *std::get<39>(value);
            }
            break;
        case 40:
            stream<< "{CoerceToDomainValue*}";
            stream << "ptr of other struct: " << (std::get<40>(value) == nullptr ? "nullptr" : "true");
            if (std::get<40>(value) != nullptr)
            {
                stream << "->" << *std::get<40>(value);
            }
            break;
        case 41:
            stream<< "{SetToDefault*}";
            stream << "ptr of other struct: " << (std::get<41>(value) == nullptr ? "nullptr" : "true");
            if (std::get<41>(value) != nullptr)
            {
                stream << "->" << *std::get<41>(value);
            }
            break;
        case 42:
            stream<< "{CurrentOfExpr*}";
            stream << "ptr of other struct: " << (std::get<42>(value) == nullptr ? "nullptr" : "true");
            if (std::get<42>(value) != nullptr)
            {
                stream << "->" << *std::get<42>(value);
            }
            break;
        case 43:
            stream<< "{NextValueExpr*}";
            stream << "ptr of other struct: " << (std::get<43>(value) == nullptr ? "nullptr" : "true");
            if (std::get<43>(value) != nullptr)
            {
                stream << "->" << *std::get<43>(value);
            }
            break;
        case 44:
            stream<< "{InferenceElem*}";
            stream << "ptr of other struct: " << (std::get<44>(value) == nullptr ? "nullptr" : "true");
            if (std::get<44>(value) != nullptr)
            {
                stream << "->" << *std::get<44>(value);
            }
            break;
        case 45:
            stream<< "{TargetEntry*}";
            stream << "ptr of other struct: " << (std::get<45>(value) == nullptr ? "nullptr" : "true");
            if (std::get<45>(value) != nullptr)
            {
                stream << "->" << *std::get<45>(value);
            }
            break;
        case 46:
            stream<< "{RangeTblRef*}";
            stream << "ptr of other struct: " << (std::get<46>(value) == nullptr ? "nullptr" : "true");
            if (std::get<46>(value) != nullptr)
            {
                stream << "->" << *std::get<46>(value);
            }
            break;
        case 47:
            stream<< "{JoinExpr*}";
            stream << "ptr of other struct: " << (std::get<47>(value) == nullptr ? "nullptr" : "true");
            if (std::get<47>(value) != nullptr)
            {
                stream << "->" << *std::get<47>(value);
            }
            break;
        case 48:
            stream<< "{FromExpr*}";
            stream << "ptr of other struct: " << (std::get<48>(value) == nullptr ? "nullptr" : "true");
            if (std::get<48>(value) != nullptr)
            {
                stream << "->" << *std::get<48>(value);
            }
            break;
        case 49:
            stream<< "{OnConflictExpr*}";
            stream << "ptr of other struct: " << (std::get<49>(value) == nullptr ? "nullptr" : "true");
            if (std::get<49>(value) != nullptr)
            {
                stream << "->" << *std::get<49>(value);
            }
            break;
        case 50:
            stream<< "{IntoClause*}";
            stream << "ptr of other struct: " << (std::get<50>(value) == nullptr ? "nullptr" : "true");
            if (std::get<50>(value) != nullptr)
            {
                stream << "->" << *std::get<50>(value);
            }
            break;
        case 51:
            stream<< "{RawStmt*}";
            stream << "ptr of other struct: " << (std::get<51>(value) == nullptr ? "nullptr" : "true");
            if (std::get<51>(value) != nullptr)
            {
                stream << "->" << *std::get<51>(value);
            }
            break;
        case 52:
            stream<< "{Query*}";
            stream << "ptr of other struct: " << (std::get<52>(value) == nullptr ? "nullptr" : "true");
            if (std::get<52>(value) != nullptr)
            {
                stream << "->" << *std::get<52>(value);
            }
            break;
        case 53:
            stream<< "{InsertStmt*}";
            stream << "ptr of other struct: " << (std::get<53>(value) == nullptr ? "nullptr" : "true");
            if (std::get<53>(value) != nullptr)
            {
                stream << "->" << *std::get<53>(value);
            }
            break;
        case 54:
            stream<< "{DeleteStmt*}";
            stream << "ptr of other struct: " << (std::get<54>(value) == nullptr ? "nullptr" : "true");
            if (std::get<54>(value) != nullptr)
            {
                stream << "->" << *std::get<54>(value);
            }
            break;
        case 55:
            stream<< "{UpdateStmt*}";
            stream << "ptr of other struct: " << (std::get<55>(value) == nullptr ? "nullptr" : "true");
            if (std::get<55>(value) != nullptr)
            {
                stream << "->" << *std::get<55>(value);
            }
            break;
        case 56:
            stream<< "{SelectStmt*}";
            stream << "ptr of other struct: " << (std::get<56>(value) == nullptr ? "nullptr" : "true");
            if (std::get<56>(value) != nullptr)
            {
                stream << "->" << *std::get<56>(value);
            }
            break;
        case 57:
            stream<< "{AlterTableStmt*}";
            stream << "ptr of other struct: " << (std::get<57>(value) == nullptr ? "nullptr" : "true");
            if (std::get<57>(value) != nullptr)
            {
                stream << "->" << *std::get<57>(value);
            }
            break;
        case 58:
            stream<< "{AlterTableCmd*}";
            stream << "ptr of other struct: " << (std::get<58>(value) == nullptr ? "nullptr" : "true");
            if (std::get<58>(value) != nullptr)
            {
                stream << "->" << *std::get<58>(value);
            }
            break;
        case 59:
            stream<< "{AlterDomainStmt*}";
            stream << "ptr of other struct: " << (std::get<59>(value) == nullptr ? "nullptr" : "true");
            if (std::get<59>(value) != nullptr)
            {
                stream << "->" << *std::get<59>(value);
            }
            break;
        case 60:
            stream<< "{SetOperationStmt*}";
            stream << "ptr of other struct: " << (std::get<60>(value) == nullptr ? "nullptr" : "true");
            if (std::get<60>(value) != nullptr)
            {
                stream << "->" << *std::get<60>(value);
            }
            break;
        case 61:
            stream<< "{GrantStmt*}";
            stream << "ptr of other struct: " << (std::get<61>(value) == nullptr ? "nullptr" : "true");
            if (std::get<61>(value) != nullptr)
            {
                stream << "->" << *std::get<61>(value);
            }
            break;
        case 62:
            stream<< "{GrantRoleStmt*}";
            stream << "ptr of other struct: " << (std::get<62>(value) == nullptr ? "nullptr" : "true");
            if (std::get<62>(value) != nullptr)
            {
                stream << "->" << *std::get<62>(value);
            }
            break;
        case 63:
            stream<< "{AlterDefaultPrivilegesStmt*}";
            stream << "ptr of other struct: " << (std::get<63>(value) == nullptr ? "nullptr" : "true");
            if (std::get<63>(value) != nullptr)
            {
                stream << "->" << *std::get<63>(value);
            }
            break;
        case 64:
            stream<< "{ClosePortalStmt*}";
            stream << "ptr of other struct: " << (std::get<64>(value) == nullptr ? "nullptr" : "true");
            if (std::get<64>(value) != nullptr)
            {
                stream << "->" << *std::get<64>(value);
            }
            break;
        case 65:
            stream<< "{ClusterStmt*}";
            stream << "ptr of other struct: " << (std::get<65>(value) == nullptr ? "nullptr" : "true");
            if (std::get<65>(value) != nullptr)
            {
                stream << "->" << *std::get<65>(value);
            }
            break;
        case 66:
            stream<< "{CopyStmt*}";
            stream << "ptr of other struct: " << (std::get<66>(value) == nullptr ? "nullptr" : "true");
            if (std::get<66>(value) != nullptr)
            {
                stream << "->" << *std::get<66>(value);
            }
            break;
        case 67:
            stream<< "{CreateStmt*}";
            stream << "ptr of other struct: " << (std::get<67>(value) == nullptr ? "nullptr" : "true");
            if (std::get<67>(value) != nullptr)
            {
                stream << "->" << *std::get<67>(value);
            }
            break;
        case 68:
            stream<< "{DefineStmt*}";
            stream << "ptr of other struct: " << (std::get<68>(value) == nullptr ? "nullptr" : "true");
            if (std::get<68>(value) != nullptr)
            {
                stream << "->" << *std::get<68>(value);
            }
            break;
        case 69:
            stream<< "{DropStmt*}";
            stream << "ptr of other struct: " << (std::get<69>(value) == nullptr ? "nullptr" : "true");
            if (std::get<69>(value) != nullptr)
            {
                stream << "->" << *std::get<69>(value);
            }
            break;
        case 70:
            stream<< "{TruncateStmt*}";
            stream << "ptr of other struct: " << (std::get<70>(value) == nullptr ? "nullptr" : "true");
            if (std::get<70>(value) != nullptr)
            {
                stream << "->" << *std::get<70>(value);
            }
            break;
        case 71:
            stream<< "{CommentStmt*}";
            stream << "ptr of other struct: " << (std::get<71>(value) == nullptr ? "nullptr" : "true");
            if (std::get<71>(value) != nullptr)
            {
                stream << "->" << *std::get<71>(value);
            }
            break;
        case 72:
            stream<< "{FetchStmt*}";
            stream << "ptr of other struct: " << (std::get<72>(value) == nullptr ? "nullptr" : "true");
            if (std::get<72>(value) != nullptr)
            {
                stream << "->" << *std::get<72>(value);
            }
            break;
        case 73:
            stream<< "{IndexStmt*}";
            stream << "ptr of other struct: " << (std::get<73>(value) == nullptr ? "nullptr" : "true");
            if (std::get<73>(value) != nullptr)
            {
                stream << "->" << *std::get<73>(value);
            }
            break;
        case 74:
            stream<< "{CreateFunctionStmt*}";
            stream << "ptr of other struct: " << (std::get<74>(value) == nullptr ? "nullptr" : "true");
            if (std::get<74>(value) != nullptr)
            {
                stream << "->" << *std::get<74>(value);
            }
            break;
        case 75:
            stream<< "{AlterFunctionStmt*}";
            stream << "ptr of other struct: " << (std::get<75>(value) == nullptr ? "nullptr" : "true");
            if (std::get<75>(value) != nullptr)
            {
                stream << "->" << *std::get<75>(value);
            }
            break;
        case 76:
            stream<< "{DoStmt*}";
            stream << "ptr of other struct: " << (std::get<76>(value) == nullptr ? "nullptr" : "true");
            if (std::get<76>(value) != nullptr)
            {
                stream << "->" << *std::get<76>(value);
            }
            break;
        case 77:
            stream<< "{RenameStmt*}";
            stream << "ptr of other struct: " << (std::get<77>(value) == nullptr ? "nullptr" : "true");
            if (std::get<77>(value) != nullptr)
            {
                stream << "->" << *std::get<77>(value);
            }
            break;
        case 78:
            stream<< "{RuleStmt*}";
            stream << "ptr of other struct: " << (std::get<78>(value) == nullptr ? "nullptr" : "true");
            if (std::get<78>(value) != nullptr)
            {
                stream << "->" << *std::get<78>(value);
            }
            break;
        case 79:
            stream<< "{NotifyStmt*}";
            stream << "ptr of other struct: " << (std::get<79>(value) == nullptr ? "nullptr" : "true");
            if (std::get<79>(value) != nullptr)
            {
                stream << "->" << *std::get<79>(value);
            }
            break;
        case 80:
            stream<< "{ListenStmt*}";
            stream << "ptr of other struct: " << (std::get<80>(value) == nullptr ? "nullptr" : "true");
            if (std::get<80>(value) != nullptr)
            {
                stream << "->" << *std::get<80>(value);
            }
            break;
        case 81:
            stream<< "{UnlistenStmt*}";
            stream << "ptr of other struct: " << (std::get<81>(value) == nullptr ? "nullptr" : "true");
            if (std::get<81>(value) != nullptr)
            {
                stream << "->" << *std::get<81>(value);
            }
            break;
        case 82:
            stream<< "{TransactionStmt*}";
            stream << "ptr of other struct: " << (std::get<82>(value) == nullptr ? "nullptr" : "true");
            if (std::get<82>(value) != nullptr)
            {
                stream << "->" << *std::get<82>(value);
            }
            break;
        case 83:
            stream<< "{ViewStmt*}";
            stream << "ptr of other struct: " << (std::get<83>(value) == nullptr ? "nullptr" : "true");
            if (std::get<83>(value) != nullptr)
            {
                stream << "->" << *std::get<83>(value);
            }
            break;
        case 84:
            stream<< "{LoadStmt*}";
            stream << "ptr of other struct: " << (std::get<84>(value) == nullptr ? "nullptr" : "true");
            if (std::get<84>(value) != nullptr)
            {
                stream << "->" << *std::get<84>(value);
            }
            break;
        case 85:
            stream<< "{CreateDomainStmt*}";
            stream << "ptr of other struct: " << (std::get<85>(value) == nullptr ? "nullptr" : "true");
            if (std::get<85>(value) != nullptr)
            {
                stream << "->" << *std::get<85>(value);
            }
            break;
        case 86:
            stream<< "{CreatedbStmt*}";
            stream << "ptr of other struct: " << (std::get<86>(value) == nullptr ? "nullptr" : "true");
            if (std::get<86>(value) != nullptr)
            {
                stream << "->" << *std::get<86>(value);
            }
            break;
        case 87:
            stream<< "{DropdbStmt*}";
            stream << "ptr of other struct: " << (std::get<87>(value) == nullptr ? "nullptr" : "true");
            if (std::get<87>(value) != nullptr)
            {
                stream << "->" << *std::get<87>(value);
            }
            break;
        case 88:
            stream<< "{VacuumStmt*}";
            stream << "ptr of other struct: " << (std::get<88>(value) == nullptr ? "nullptr" : "true");
            if (std::get<88>(value) != nullptr)
            {
                stream << "->" << *std::get<88>(value);
            }
            break;
        case 89:
            stream<< "{ExplainStmt*}";
            stream << "ptr of other struct: " << (std::get<89>(value) == nullptr ? "nullptr" : "true");
            if (std::get<89>(value) != nullptr)
            {
                stream << "->" << *std::get<89>(value);
            }
            break;
        case 90:
            stream<< "{CreateTableAsStmt*}";
            stream << "ptr of other struct: " << (std::get<90>(value) == nullptr ? "nullptr" : "true");
            if (std::get<90>(value) != nullptr)
            {
                stream << "->" << *std::get<90>(value);
            }
            break;
        case 91:
            stream<< "{CreateSeqStmt*}";
            stream << "ptr of other struct: " << (std::get<91>(value) == nullptr ? "nullptr" : "true");
            if (std::get<91>(value) != nullptr)
            {
                stream << "->" << *std::get<91>(value);
            }
            break;
        case 92:
            stream<< "{AlterSeqStmt*}";
            stream << "ptr of other struct: " << (std::get<92>(value) == nullptr ? "nullptr" : "true");
            if (std::get<92>(value) != nullptr)
            {
                stream << "->" << *std::get<92>(value);
            }
            break;
        case 93:
            stream<< "{VariableSetStmt*}";
            stream << "ptr of other struct: " << (std::get<93>(value) == nullptr ? "nullptr" : "true");
            if (std::get<93>(value) != nullptr)
            {
                stream << "->" << *std::get<93>(value);
            }
            break;
        case 94:
            stream<< "{VariableShowStmt*}";
            stream << "ptr of other struct: " << (std::get<94>(value) == nullptr ? "nullptr" : "true");
            if (std::get<94>(value) != nullptr)
            {
                stream << "->" << *std::get<94>(value);
            }
            break;
        case 95:
            stream<< "{DiscardStmt*}";
            stream << "ptr of other struct: " << (std::get<95>(value) == nullptr ? "nullptr" : "true");
            if (std::get<95>(value) != nullptr)
            {
                stream << "->" << *std::get<95>(value);
            }
            break;
        case 96:
            stream<< "{CreateTrigStmt*}";
            stream << "ptr of other struct: " << (std::get<96>(value) == nullptr ? "nullptr" : "true");
            if (std::get<96>(value) != nullptr)
            {
                stream << "->" << *std::get<96>(value);
            }
            break;
        case 97:
            stream<< "{CreatePLangStmt*}";
            stream << "ptr of other struct: " << (std::get<97>(value) == nullptr ? "nullptr" : "true");
            if (std::get<97>(value) != nullptr)
            {
                stream << "->" << *std::get<97>(value);
            }
            break;
        case 98:
            stream<< "{CreateRoleStmt*}";
            stream << "ptr of other struct: " << (std::get<98>(value) == nullptr ? "nullptr" : "true");
            if (std::get<98>(value) != nullptr)
            {
                stream << "->" << *std::get<98>(value);
            }
            break;
        case 99:
            stream<< "{AlterRoleStmt*}";
            stream << "ptr of other struct: " << (std::get<99>(value) == nullptr ? "nullptr" : "true");
            if (std::get<99>(value) != nullptr)
            {
                stream << "->" << *std::get<99>(value);
            }
            break;
        case 100:
            stream<< "{DropRoleStmt*}";
            stream << "ptr of other struct: " << (std::get<100>(value) == nullptr ? "nullptr" : "true");
            if (std::get<100>(value) != nullptr)
            {
                stream << "->" << *std::get<100>(value);
            }
            break;
        case 101:
            stream<< "{LockStmt*}";
            stream << "ptr of other struct: " << (std::get<101>(value) == nullptr ? "nullptr" : "true");
            if (std::get<101>(value) != nullptr)
            {
                stream << "->" << *std::get<101>(value);
            }
            break;
        case 102:
            stream<< "{ConstraintsSetStmt*}";
            stream << "ptr of other struct: " << (std::get<102>(value) == nullptr ? "nullptr" : "true");
            if (std::get<102>(value) != nullptr)
            {
                stream << "->" << *std::get<102>(value);
            }
            break;
        case 103:
            stream<< "{ReindexStmt*}";
            stream << "ptr of other struct: " << (std::get<103>(value) == nullptr ? "nullptr" : "true");
            if (std::get<103>(value) != nullptr)
            {
                stream << "->" << *std::get<103>(value);
            }
            break;
        case 104:
            stream<< "{CheckPointStmt*}";
            stream << "ptr of other struct: " << (std::get<104>(value) == nullptr ? "nullptr" : "true");
            if (std::get<104>(value) != nullptr)
            {
                stream << "->" << *std::get<104>(value);
            }
            break;
        case 105:
            stream<< "{CreateSchemaStmt*}";
            stream << "ptr of other struct: " << (std::get<105>(value) == nullptr ? "nullptr" : "true");
            if (std::get<105>(value) != nullptr)
            {
                stream << "->" << *std::get<105>(value);
            }
            break;
        case 106:
            stream<< "{AlterDatabaseStmt*}";
            stream << "ptr of other struct: " << (std::get<106>(value) == nullptr ? "nullptr" : "true");
            if (std::get<106>(value) != nullptr)
            {
                stream << "->" << *std::get<106>(value);
            }
            break;
        case 107:
            stream<< "{AlterDatabaseSetStmt*}";
            stream << "ptr of other struct: " << (std::get<107>(value) == nullptr ? "nullptr" : "true");
            if (std::get<107>(value) != nullptr)
            {
                stream << "->" << *std::get<107>(value);
            }
            break;
        case 108:
            stream<< "{AlterRoleSetStmt*}";
            stream << "ptr of other struct: " << (std::get<108>(value) == nullptr ? "nullptr" : "true");
            if (std::get<108>(value) != nullptr)
            {
                stream << "->" << *std::get<108>(value);
            }
            break;
        case 109:
            stream<< "{CreateConversionStmt*}";
            stream << "ptr of other struct: " << (std::get<109>(value) == nullptr ? "nullptr" : "true");
            if (std::get<109>(value) != nullptr)
            {
                stream << "->" << *std::get<109>(value);
            }
            break;
        case 110:
            stream<< "{CreateCastStmt*}";
            stream << "ptr of other struct: " << (std::get<110>(value) == nullptr ? "nullptr" : "true");
            if (std::get<110>(value) != nullptr)
            {
                stream << "->" << *std::get<110>(value);
            }
            break;
        case 111:
            stream<< "{CreateOpClassStmt*}";
            stream << "ptr of other struct: " << (std::get<111>(value) == nullptr ? "nullptr" : "true");
            if (std::get<111>(value) != nullptr)
            {
                stream << "->" << *std::get<111>(value);
            }
            break;
        case 112:
            stream<< "{CreateOpFamilyStmt*}";
            stream << "ptr of other struct: " << (std::get<112>(value) == nullptr ? "nullptr" : "true");
            if (std::get<112>(value) != nullptr)
            {
                stream << "->" << *std::get<112>(value);
            }
            break;
        case 113:
            stream<< "{AlterOpFamilyStmt*}";
            stream << "ptr of other struct: " << (std::get<113>(value) == nullptr ? "nullptr" : "true");
            if (std::get<113>(value) != nullptr)
            {
                stream << "->" << *std::get<113>(value);
            }
            break;
        case 114:
            stream<< "{PrepareStmt*}";
            stream << "ptr of other struct: " << (std::get<114>(value) == nullptr ? "nullptr" : "true");
            if (std::get<114>(value) != nullptr)
            {
                stream << "->" << *std::get<114>(value);
            }
            break;
        case 115:
            stream<< "{ExecuteStmt*}";
            stream << "ptr of other struct: " << (std::get<115>(value) == nullptr ? "nullptr" : "true");
            if (std::get<115>(value) != nullptr)
            {
                stream << "->" << *std::get<115>(value);
            }
            break;
        case 116:
            stream<< "{DeallocateStmt*}";
            stream << "ptr of other struct: " << (std::get<116>(value) == nullptr ? "nullptr" : "true");
            if (std::get<116>(value) != nullptr)
            {
                stream << "->" << *std::get<116>(value);
            }
            break;
        case 117:
            stream<< "{DeclareCursorStmt*}";
            stream << "ptr of other struct: " << (std::get<117>(value) == nullptr ? "nullptr" : "true");
            if (std::get<117>(value) != nullptr)
            {
                stream << "->" << *std::get<117>(value);
            }
            break;
        case 118:
            stream<< "{CreateTableSpaceStmt*}";
            stream << "ptr of other struct: " << (std::get<118>(value) == nullptr ? "nullptr" : "true");
            if (std::get<118>(value) != nullptr)
            {
                stream << "->" << *std::get<118>(value);
            }
            break;
        case 119:
            stream<< "{DropTableSpaceStmt*}";
            stream << "ptr of other struct: " << (std::get<119>(value) == nullptr ? "nullptr" : "true");
            if (std::get<119>(value) != nullptr)
            {
                stream << "->" << *std::get<119>(value);
            }
            break;
        case 120:
            stream<< "{AlterObjectDependsStmt*}";
            stream << "ptr of other struct: " << (std::get<120>(value) == nullptr ? "nullptr" : "true");
            if (std::get<120>(value) != nullptr)
            {
                stream << "->" << *std::get<120>(value);
            }
            break;
        case 121:
            stream<< "{AlterObjectSchemaStmt*}";
            stream << "ptr of other struct: " << (std::get<121>(value) == nullptr ? "nullptr" : "true");
            if (std::get<121>(value) != nullptr)
            {
                stream << "->" << *std::get<121>(value);
            }
            break;
        case 122:
            stream<< "{AlterOwnerStmt*}";
            stream << "ptr of other struct: " << (std::get<122>(value) == nullptr ? "nullptr" : "true");
            if (std::get<122>(value) != nullptr)
            {
                stream << "->" << *std::get<122>(value);
            }
            break;
        case 123:
            stream<< "{AlterOperatorStmt*}";
            stream << "ptr of other struct: " << (std::get<123>(value) == nullptr ? "nullptr" : "true");
            if (std::get<123>(value) != nullptr)
            {
                stream << "->" << *std::get<123>(value);
            }
            break;
        case 124:
            stream<< "{AlterTypeStmt*}";
            stream << "ptr of other struct: " << (std::get<124>(value) == nullptr ? "nullptr" : "true");
            if (std::get<124>(value) != nullptr)
            {
                stream << "->" << *std::get<124>(value);
            }
            break;
        case 125:
            stream<< "{DropOwnedStmt*}";
            stream << "ptr of other struct: " << (std::get<125>(value) == nullptr ? "nullptr" : "true");
            if (std::get<125>(value) != nullptr)
            {
                stream << "->" << *std::get<125>(value);
            }
            break;
        case 126:
            stream<< "{ReassignOwnedStmt*}";
            stream << "ptr of other struct: " << (std::get<126>(value) == nullptr ? "nullptr" : "true");
            if (std::get<126>(value) != nullptr)
            {
                stream << "->" << *std::get<126>(value);
            }
            break;
        case 127:
            stream<< "{CompositeTypeStmt*}";
            stream << "ptr of other struct: " << (std::get<127>(value) == nullptr ? "nullptr" : "true");
            if (std::get<127>(value) != nullptr)
            {
                stream << "->" << *std::get<127>(value);
            }
            break;
        case 128:
            stream<< "{CreateEnumStmt*}";
            stream << "ptr of other struct: " << (std::get<128>(value) == nullptr ? "nullptr" : "true");
            if (std::get<128>(value) != nullptr)
            {
                stream << "->" << *std::get<128>(value);
            }
            break;
        case 129:
            stream<< "{CreateRangeStmt*}";
            stream << "ptr of other struct: " << (std::get<129>(value) == nullptr ? "nullptr" : "true");
            if (std::get<129>(value) != nullptr)
            {
                stream << "->" << *std::get<129>(value);
            }
            break;
        case 130:
            stream<< "{AlterEnumStmt*}";
            stream << "ptr of other struct: " << (std::get<130>(value) == nullptr ? "nullptr" : "true");
            if (std::get<130>(value) != nullptr)
            {
                stream << "->" << *std::get<130>(value);
            }
            break;
        case 131:
            stream<< "{AlterTSDictionaryStmt*}";
            stream << "ptr of other struct: " << (std::get<131>(value) == nullptr ? "nullptr" : "true");
            if (std::get<131>(value) != nullptr)
            {
                stream << "->" << *std::get<131>(value);
            }
            break;
        case 132:
            stream<< "{AlterTSConfigurationStmt*}";
            stream << "ptr of other struct: " << (std::get<132>(value) == nullptr ? "nullptr" : "true");
            if (std::get<132>(value) != nullptr)
            {
                stream << "->" << *std::get<132>(value);
            }
            break;
        case 133:
            stream<< "{CreateFdwStmt*}";
            stream << "ptr of other struct: " << (std::get<133>(value) == nullptr ? "nullptr" : "true");
            if (std::get<133>(value) != nullptr)
            {
                stream << "->" << *std::get<133>(value);
            }
            break;
        case 134:
            stream<< "{AlterFdwStmt*}";
            stream << "ptr of other struct: " << (std::get<134>(value) == nullptr ? "nullptr" : "true");
            if (std::get<134>(value) != nullptr)
            {
                stream << "->" << *std::get<134>(value);
            }
            break;
        case 135:
            stream<< "{CreateForeignServerStmt*}";
            stream << "ptr of other struct: " << (std::get<135>(value) == nullptr ? "nullptr" : "true");
            if (std::get<135>(value) != nullptr)
            {
                stream << "->" << *std::get<135>(value);
            }
            break;
        case 136:
            stream<< "{AlterForeignServerStmt*}";
            stream << "ptr of other struct: " << (std::get<136>(value) == nullptr ? "nullptr" : "true");
            if (std::get<136>(value) != nullptr)
            {
                stream << "->" << *std::get<136>(value);
            }
            break;
        case 137:
            stream<< "{CreateUserMappingStmt*}";
            stream << "ptr of other struct: " << (std::get<137>(value) == nullptr ? "nullptr" : "true");
            if (std::get<137>(value) != nullptr)
            {
                stream << "->" << *std::get<137>(value);
            }
            break;
        case 138:
            stream<< "{AlterUserMappingStmt*}";
            stream << "ptr of other struct: " << (std::get<138>(value) == nullptr ? "nullptr" : "true");
            if (std::get<138>(value) != nullptr)
            {
                stream << "->" << *std::get<138>(value);
            }
            break;
        case 139:
            stream<< "{DropUserMappingStmt*}";
            stream << "ptr of other struct: " << (std::get<139>(value) == nullptr ? "nullptr" : "true");
            if (std::get<139>(value) != nullptr)
            {
                stream << "->" << *std::get<139>(value);
            }
            break;
        case 140:
            stream<< "{AlterTableSpaceOptionsStmt*}";
            stream << "ptr of other struct: " << (std::get<140>(value) == nullptr ? "nullptr" : "true");
            if (std::get<140>(value) != nullptr)
            {
                stream << "->" << *std::get<140>(value);
            }
            break;
        case 141:
            stream<< "{AlterTableMoveAllStmt*}";
            stream << "ptr of other struct: " << (std::get<141>(value) == nullptr ? "nullptr" : "true");
            if (std::get<141>(value) != nullptr)
            {
                stream << "->" << *std::get<141>(value);
            }
            break;
        case 142:
            stream<< "{SecLabelStmt*}";
            stream << "ptr of other struct: " << (std::get<142>(value) == nullptr ? "nullptr" : "true");
            if (std::get<142>(value) != nullptr)
            {
                stream << "->" << *std::get<142>(value);
            }
            break;
        case 143:
            stream<< "{CreateForeignTableStmt*}";
            stream << "ptr of other struct: " << (std::get<143>(value) == nullptr ? "nullptr" : "true");
            if (std::get<143>(value) != nullptr)
            {
                stream << "->" << *std::get<143>(value);
            }
            break;
        case 144:
            stream<< "{ImportForeignSchemaStmt*}";
            stream << "ptr of other struct: " << (std::get<144>(value) == nullptr ? "nullptr" : "true");
            if (std::get<144>(value) != nullptr)
            {
                stream << "->" << *std::get<144>(value);
            }
            break;
        case 145:
            stream<< "{CreateExtensionStmt*}";
            stream << "ptr of other struct: " << (std::get<145>(value) == nullptr ? "nullptr" : "true");
            if (std::get<145>(value) != nullptr)
            {
                stream << "->" << *std::get<145>(value);
            }
            break;
        case 146:
            stream<< "{AlterExtensionStmt*}";
            stream << "ptr of other struct: " << (std::get<146>(value) == nullptr ? "nullptr" : "true");
            if (std::get<146>(value) != nullptr)
            {
                stream << "->" << *std::get<146>(value);
            }
            break;
        case 147:
            stream<< "{AlterExtensionContentsStmt*}";
            stream << "ptr of other struct: " << (std::get<147>(value) == nullptr ? "nullptr" : "true");
            if (std::get<147>(value) != nullptr)
            {
                stream << "->" << *std::get<147>(value);
            }
            break;
        case 148:
            stream<< "{CreateEventTrigStmt*}";
            stream << "ptr of other struct: " << (std::get<148>(value) == nullptr ? "nullptr" : "true");
            if (std::get<148>(value) != nullptr)
            {
                stream << "->" << *std::get<148>(value);
            }
            break;
        case 149:
            stream<< "{AlterEventTrigStmt*}";
            stream << "ptr of other struct: " << (std::get<149>(value) == nullptr ? "nullptr" : "true");
            if (std::get<149>(value) != nullptr)
            {
                stream << "->" << *std::get<149>(value);
            }
            break;
        case 150:
            stream<< "{RefreshMatViewStmt*}";
            stream << "ptr of other struct: " << (std::get<150>(value) == nullptr ? "nullptr" : "true");
            if (std::get<150>(value) != nullptr)
            {
                stream << "->" << *std::get<150>(value);
            }
            break;
        case 151:
            stream<< "{ReplicaIdentityStmt*}";
            stream << "ptr of other struct: " << (std::get<151>(value) == nullptr ? "nullptr" : "true");
            if (std::get<151>(value) != nullptr)
            {
                stream << "->" << *std::get<151>(value);
            }
            break;
        case 152:
            stream<< "{AlterSystemStmt*}";
            stream << "ptr of other struct: " << (std::get<152>(value) == nullptr ? "nullptr" : "true");
            if (std::get<152>(value) != nullptr)
            {
                stream << "->" << *std::get<152>(value);
            }
            break;
        case 153:
            stream<< "{CreatePolicyStmt*}";
            stream << "ptr of other struct: " << (std::get<153>(value) == nullptr ? "nullptr" : "true");
            if (std::get<153>(value) != nullptr)
            {
                stream << "->" << *std::get<153>(value);
            }
            break;
        case 154:
            stream<< "{AlterPolicyStmt*}";
            stream << "ptr of other struct: " << (std::get<154>(value) == nullptr ? "nullptr" : "true");
            if (std::get<154>(value) != nullptr)
            {
                stream << "->" << *std::get<154>(value);
            }
            break;
        case 155:
            stream<< "{CreateTransformStmt*}";
            stream << "ptr of other struct: " << (std::get<155>(value) == nullptr ? "nullptr" : "true");
            if (std::get<155>(value) != nullptr)
            {
                stream << "->" << *std::get<155>(value);
            }
            break;
        case 156:
            stream<< "{CreateAmStmt*}";
            stream << "ptr of other struct: " << (std::get<156>(value) == nullptr ? "nullptr" : "true");
            if (std::get<156>(value) != nullptr)
            {
                stream << "->" << *std::get<156>(value);
            }
            break;
        case 157:
            stream<< "{CreatePublicationStmt*}";
            stream << "ptr of other struct: " << (std::get<157>(value) == nullptr ? "nullptr" : "true");
            if (std::get<157>(value) != nullptr)
            {
                stream << "->" << *std::get<157>(value);
            }
            break;
        case 158:
            stream<< "{AlterPublicationStmt*}";
            stream << "ptr of other struct: " << (std::get<158>(value) == nullptr ? "nullptr" : "true");
            if (std::get<158>(value) != nullptr)
            {
                stream << "->" << *std::get<158>(value);
            }
            break;
        case 159:
            stream<< "{CreateSubscriptionStmt*}";
            stream << "ptr of other struct: " << (std::get<159>(value) == nullptr ? "nullptr" : "true");
            if (std::get<159>(value) != nullptr)
            {
                stream << "->" << *std::get<159>(value);
            }
            break;
        case 160:
            stream<< "{AlterSubscriptionStmt*}";
            stream << "ptr of other struct: " << (std::get<160>(value) == nullptr ? "nullptr" : "true");
            if (std::get<160>(value) != nullptr)
            {
                stream << "->" << *std::get<160>(value);
            }
            break;
        case 161:
            stream<< "{DropSubscriptionStmt*}";
            stream << "ptr of other struct: " << (std::get<161>(value) == nullptr ? "nullptr" : "true");
            if (std::get<161>(value) != nullptr)
            {
                stream << "->" << *std::get<161>(value);
            }
            break;
        case 162:
            stream<< "{CreateStatsStmt*}";
            stream << "ptr of other struct: " << (std::get<162>(value) == nullptr ? "nullptr" : "true");
            if (std::get<162>(value) != nullptr)
            {
                stream << "->" << *std::get<162>(value);
            }
            break;
        case 163:
            stream<< "{AlterCollationStmt*}";
            stream << "ptr of other struct: " << (std::get<163>(value) == nullptr ? "nullptr" : "true");
            if (std::get<163>(value) != nullptr)
            {
                stream << "->" << *std::get<163>(value);
            }
            break;
        case 164:
            stream<< "{CallStmt*}";
            stream << "ptr of other struct: " << (std::get<164>(value) == nullptr ? "nullptr" : "true");
            if (std::get<164>(value) != nullptr)
            {
                stream << "->" << *std::get<164>(value);
            }
            break;
        case 165:
            stream<< "{AlterStatsStmt*}";
            stream << "ptr of other struct: " << (std::get<165>(value) == nullptr ? "nullptr" : "true");
            if (std::get<165>(value) != nullptr)
            {
                stream << "->" << *std::get<165>(value);
            }
            break;
        case 166:
            stream<< "{A_Expr*}";
            stream << "ptr of other struct: " << (std::get<166>(value) == nullptr ? "nullptr" : "true");
            if (std::get<166>(value) != nullptr)
            {
                stream << "->" << *std::get<166>(value);
            }
            break;
        case 167:
            stream<< "{ColumnRef*}";
            stream << "ptr of other struct: " << (std::get<167>(value) == nullptr ? "nullptr" : "true");
            if (std::get<167>(value) != nullptr)
            {
                stream << "->" << *std::get<167>(value);
            }
            break;
        case 168:
            stream<< "{ParamRef*}";
            stream << "ptr of other struct: " << (std::get<168>(value) == nullptr ? "nullptr" : "true");
            if (std::get<168>(value) != nullptr)
            {
                stream << "->" << *std::get<168>(value);
            }
            break;
        case 169:
            stream<< "{A_Const*}";
            stream << "ptr of other struct: " << (std::get<169>(value) == nullptr ? "nullptr" : "true");
            if (std::get<169>(value) != nullptr)
            {
                stream << "->" << *std::get<169>(value);
            }
            break;
        case 170:
            stream<< "{FuncCall*}";
            stream << "ptr of other struct: " << (std::get<170>(value) == nullptr ? "nullptr" : "true");
            if (std::get<170>(value) != nullptr)
            {
                stream << "->" << *std::get<170>(value);
            }
            break;
        case 171:
            stream<< "{A_Star*}";
            stream << "ptr of other struct: " << (std::get<171>(value) == nullptr ? "nullptr" : "true");
            if (std::get<171>(value) != nullptr)
            {
                stream << "->" << *std::get<171>(value);
            }
            break;
        case 172:
            stream<< "{A_Indices*}";
            stream << "ptr of other struct: " << (std::get<172>(value) == nullptr ? "nullptr" : "true");
            if (std::get<172>(value) != nullptr)
            {
                stream << "->" << *std::get<172>(value);
            }
            break;
        case 173:
            stream<< "{A_Indirection*}";
            stream << "ptr of other struct: " << (std::get<173>(value) == nullptr ? "nullptr" : "true");
            if (std::get<173>(value) != nullptr)
            {
                stream << "->" << *std::get<173>(value);
            }
            break;
        case 174:
            stream<< "{A_ArrayExpr*}";
            stream << "ptr of other struct: " << (std::get<174>(value) == nullptr ? "nullptr" : "true");
            if (std::get<174>(value) != nullptr)
            {
                stream << "->" << *std::get<174>(value);
            }
            break;
        case 175:
            stream<< "{ResTarget*}";
            stream << "ptr of other struct: " << (std::get<175>(value) == nullptr ? "nullptr" : "true");
            if (std::get<175>(value) != nullptr)
            {
                stream << "->" << *std::get<175>(value);
            }
            break;
        case 176:
            stream<< "{MultiAssignRef*}";
            stream << "ptr of other struct: " << (std::get<176>(value) == nullptr ? "nullptr" : "true");
            if (std::get<176>(value) != nullptr)
            {
                stream << "->" << *std::get<176>(value);
            }
            break;
        case 177:
            stream<< "{TypeCast*}";
            stream << "ptr of other struct: " << (std::get<177>(value) == nullptr ? "nullptr" : "true");
            if (std::get<177>(value) != nullptr)
            {
                stream << "->" << *std::get<177>(value);
            }
            break;
        case 178:
            stream<< "{CollateClause*}";
            stream << "ptr of other struct: " << (std::get<178>(value) == nullptr ? "nullptr" : "true");
            if (std::get<178>(value) != nullptr)
            {
                stream << "->" << *std::get<178>(value);
            }
            break;
        case 179:
            stream<< "{SortBy*}";
            stream << "ptr of other struct: " << (std::get<179>(value) == nullptr ? "nullptr" : "true");
            if (std::get<179>(value) != nullptr)
            {
                stream << "->" << *std::get<179>(value);
            }
            break;
        case 180:
            stream<< "{WindowDef*}";
            stream << "ptr of other struct: " << (std::get<180>(value) == nullptr ? "nullptr" : "true");
            if (std::get<180>(value) != nullptr)
            {
                stream << "->" << *std::get<180>(value);
            }
            break;
        case 181:
            stream<< "{RangeSubselect*}";
            stream << "ptr of other struct: " << (std::get<181>(value) == nullptr ? "nullptr" : "true");
            if (std::get<181>(value) != nullptr)
            {
                stream << "->" << *std::get<181>(value);
            }
            break;
        case 182:
            stream<< "{RangeFunction*}";
            stream << "ptr of other struct: " << (std::get<182>(value) == nullptr ? "nullptr" : "true");
            if (std::get<182>(value) != nullptr)
            {
                stream << "->" << *std::get<182>(value);
            }
            break;
        case 183:
            stream<< "{RangeTableSample*}";
            stream << "ptr of other struct: " << (std::get<183>(value) == nullptr ? "nullptr" : "true");
            if (std::get<183>(value) != nullptr)
            {
                stream << "->" << *std::get<183>(value);
            }
            break;
        case 184:
            stream<< "{RangeTableFunc*}";
            stream << "ptr of other struct: " << (std::get<184>(value) == nullptr ? "nullptr" : "true");
            if (std::get<184>(value) != nullptr)
            {
                stream << "->" << *std::get<184>(value);
            }
            break;
        case 185:
            stream<< "{RangeTableFuncCol*}";
            stream << "ptr of other struct: " << (std::get<185>(value) == nullptr ? "nullptr" : "true");
            if (std::get<185>(value) != nullptr)
            {
                stream << "->" << *std::get<185>(value);
            }
            break;
        case 186:
            stream<< "{TypeName*}";
            stream << "ptr of other struct: " << (std::get<186>(value) == nullptr ? "nullptr" : "true");
            if (std::get<186>(value) != nullptr)
            {
                stream << "->" << *std::get<186>(value);
            }
            break;
        case 187:
            stream<< "{ColumnDef*}";
            stream << "ptr of other struct: " << (std::get<187>(value) == nullptr ? "nullptr" : "true");
            if (std::get<187>(value) != nullptr)
            {
                stream << "->" << *std::get<187>(value);
            }
            break;
        case 188:
            stream<< "{IndexElem*}";
            stream << "ptr of other struct: " << (std::get<188>(value) == nullptr ? "nullptr" : "true");
            if (std::get<188>(value) != nullptr)
            {
                stream << "->" << *std::get<188>(value);
            }
            break;
        case 189:
            stream<< "{Constraint*}";
            stream << "ptr of other struct: " << (std::get<189>(value) == nullptr ? "nullptr" : "true");
            if (std::get<189>(value) != nullptr)
            {
                stream << "->" << *std::get<189>(value);
            }
            break;
        case 190:
            stream<< "{DefElem*}";
            stream << "ptr of other struct: " << (std::get<190>(value) == nullptr ? "nullptr" : "true");
            if (std::get<190>(value) != nullptr)
            {
                stream << "->" << *std::get<190>(value);
            }
            break;
        case 191:
            stream<< "{RangeTblEntry*}";
            stream << "ptr of other struct: " << (std::get<191>(value) == nullptr ? "nullptr" : "true");
            if (std::get<191>(value) != nullptr)
            {
                stream << "->" << *std::get<191>(value);
            }
            break;
        case 192:
            stream<< "{RangeTblFunction*}";
            stream << "ptr of other struct: " << (std::get<192>(value) == nullptr ? "nullptr" : "true");
            if (std::get<192>(value) != nullptr)
            {
                stream << "->" << *std::get<192>(value);
            }
            break;
        case 193:
            stream<< "{TableSampleClause*}";
            stream << "ptr of other struct: " << (std::get<193>(value) == nullptr ? "nullptr" : "true");
            if (std::get<193>(value) != nullptr)
            {
                stream << "->" << *std::get<193>(value);
            }
            break;
        case 194:
            stream<< "{WithCheckOption*}";
            stream << "ptr of other struct: " << (std::get<194>(value) == nullptr ? "nullptr" : "true");
            if (std::get<194>(value) != nullptr)
            {
                stream << "->" << *std::get<194>(value);
            }
            break;
        case 195:
            stream<< "{SortGroupClause*}";
            stream << "ptr of other struct: " << (std::get<195>(value) == nullptr ? "nullptr" : "true");
            if (std::get<195>(value) != nullptr)
            {
                stream << "->" << *std::get<195>(value);
            }
            break;
        case 196:
            stream<< "{GroupingSet*}";
            stream << "ptr of other struct: " << (std::get<196>(value) == nullptr ? "nullptr" : "true");
            if (std::get<196>(value) != nullptr)
            {
                stream << "->" << *std::get<196>(value);
            }
            break;
        case 197:
            stream<< "{WindowClause*}";
            stream << "ptr of other struct: " << (std::get<197>(value) == nullptr ? "nullptr" : "true");
            if (std::get<197>(value) != nullptr)
            {
                stream << "->" << *std::get<197>(value);
            }
            break;
        case 198:
            stream<< "{ObjectWithArgs*}";
            stream << "ptr of other struct: " << (std::get<198>(value) == nullptr ? "nullptr" : "true");
            if (std::get<198>(value) != nullptr)
            {
                stream << "->" << *std::get<198>(value);
            }
            break;
        case 199:
            stream<< "{AccessPriv*}";
            stream << "ptr of other struct: " << (std::get<199>(value) == nullptr ? "nullptr" : "true");
            if (std::get<199>(value) != nullptr)
            {
                stream << "->" << *std::get<199>(value);
            }
            break;
        case 200:
            stream<< "{CreateOpClassItem*}";
            stream << "ptr of other struct: " << (std::get<200>(value) == nullptr ? "nullptr" : "true");
            if (std::get<200>(value) != nullptr)
            {
                stream << "->" << *std::get<200>(value);
            }
            break;
        case 201:
            stream<< "{TableLikeClause*}";
            stream << "ptr of other struct: " << (std::get<201>(value) == nullptr ? "nullptr" : "true");
            if (std::get<201>(value) != nullptr)
            {
                stream << "->" << *std::get<201>(value);
            }
            break;
        case 202:
            stream<< "{FunctionParameter*}";
            stream << "ptr of other struct: " << (std::get<202>(value) == nullptr ? "nullptr" : "true");
            if (std::get<202>(value) != nullptr)
            {
                stream << "->" << *std::get<202>(value);
            }
            break;
        case 203:
            stream<< "{LockingClause*}";
            stream << "ptr of other struct: " << (std::get<203>(value) == nullptr ? "nullptr" : "true");
            if (std::get<203>(value) != nullptr)
            {
                stream << "->" << *std::get<203>(value);
            }
            break;
        case 204:
            stream<< "{RowMarkClause*}";
            stream << "ptr of other struct: " << (std::get<204>(value) == nullptr ? "nullptr" : "true");
            if (std::get<204>(value) != nullptr)
            {
                stream << "->" << *std::get<204>(value);
            }
            break;
        case 205:
            stream<< "{XmlSerialize*}";
            stream << "ptr of other struct: " << (std::get<205>(value) == nullptr ? "nullptr" : "true");
            if (std::get<205>(value) != nullptr)
            {
                stream << "->" << *std::get<205>(value);
            }
            break;
        case 206:
            stream<< "{WithClause*}";
            stream << "ptr of other struct: " << (std::get<206>(value) == nullptr ? "nullptr" : "true");
            if (std::get<206>(value) != nullptr)
            {
                stream << "->" << *std::get<206>(value);
            }
            break;
        case 207:
            stream<< "{InferClause*}";
            stream << "ptr of other struct: " << (std::get<207>(value) == nullptr ? "nullptr" : "true");
            if (std::get<207>(value) != nullptr)
            {
                stream << "->" << *std::get<207>(value);
            }
            break;
        case 208:
            stream<< "{OnConflictClause*}";
            stream << "ptr of other struct: " << (std::get<208>(value) == nullptr ? "nullptr" : "true");
            if (std::get<208>(value) != nullptr)
            {
                stream << "->" << *std::get<208>(value);
            }
            break;
        case 209:
            stream<< "{CommonTableExpr*}";
            stream << "ptr of other struct: " << (std::get<209>(value) == nullptr ? "nullptr" : "true");
            if (std::get<209>(value) != nullptr)
            {
                stream << "->" << *std::get<209>(value);
            }
            break;
        case 210:
            stream<< "{RoleSpec*}";
            stream << "ptr of other struct: " << (std::get<210>(value) == nullptr ? "nullptr" : "true");
            if (std::get<210>(value) != nullptr)
            {
                stream << "->" << *std::get<210>(value);
            }
            break;
        case 211:
            stream<< "{TriggerTransition*}";
            stream << "ptr of other struct: " << (std::get<211>(value) == nullptr ? "nullptr" : "true");
            if (std::get<211>(value) != nullptr)
            {
                stream << "->" << *std::get<211>(value);
            }
            break;
        case 212:
            stream<< "{PartitionElem*}";
            stream << "ptr of other struct: " << (std::get<212>(value) == nullptr ? "nullptr" : "true");
            if (std::get<212>(value) != nullptr)
            {
                stream << "->" << *std::get<212>(value);
            }
            break;
        case 213:
            stream<< "{PartitionSpec*}";
            stream << "ptr of other struct: " << (std::get<213>(value) == nullptr ? "nullptr" : "true");
            if (std::get<213>(value) != nullptr)
            {
                stream << "->" << *std::get<213>(value);
            }
            break;
        case 214:
            stream<< "{PartitionBoundSpec*}";
            stream << "ptr of other struct: " << (std::get<214>(value) == nullptr ? "nullptr" : "true");
            if (std::get<214>(value) != nullptr)
            {
                stream << "->" << *std::get<214>(value);
            }
            break;
        case 215:
            stream<< "{PartitionRangeDatum*}";
            stream << "ptr of other struct: " << (std::get<215>(value) == nullptr ? "nullptr" : "true");
            if (std::get<215>(value) != nullptr)
            {
                stream << "->" << *std::get<215>(value);
            }
            break;
        case 216:
            stream<< "{PartitionCmd*}";
            stream << "ptr of other struct: " << (std::get<216>(value) == nullptr ? "nullptr" : "true");
            if (std::get<216>(value) != nullptr)
            {
                stream << "->" << *std::get<216>(value);
            }
            break;
        case 217:
            stream<< "{VacuumRelation*}";
            stream << "ptr of other struct: " << (std::get<217>(value) == nullptr ? "nullptr" : "true");
            if (std::get<217>(value) != nullptr)
            {
                stream << "->" << *std::get<217>(value);
            }
            break;
        case 218:
            stream<< "{InlineCodeBlock*}";
            stream << "ptr of other struct: " << (std::get<218>(value) == nullptr ? "nullptr" : "true");
            if (std::get<218>(value) != nullptr)
            {
                stream << "->" << *std::get<218>(value);
            }
            break;
        case 219:
            stream<< "{CallContext*}";
            stream << "ptr of other struct: " << (std::get<219>(value) == nullptr ? "nullptr" : "true");
            if (std::get<219>(value) != nullptr)
            {
                stream << "->" << *std::get<219>(value);
            }
            break;
        case 220:
            stream<< "{Integer*}";
            stream << "ptr of other struct: " << (std::get<220>(value) == nullptr ? "nullptr" : "true");
            if (std::get<220>(value) != nullptr)
            {
                stream << "->" << *std::get<220>(value);
            }
            break;
        case 221:
            stream<< "{Float*}";
            stream << "ptr of other struct: " << (std::get<221>(value) == nullptr ? "nullptr" : "true");
            if (std::get<221>(value) != nullptr)
            {
                stream << "->" << *std::get<221>(value);
            }
            break;
        case 222:
            stream<< "{String*}";
            stream << "ptr of other struct: " << (std::get<222>(value) == nullptr ? "nullptr" : "true");
            if (std::get<222>(value) != nullptr)
            {
                stream << "->" << *std::get<222>(value);
            }
            break;
        case 223:
            stream<< "{BitString*}";
            stream << "ptr of other struct: " << (std::get<223>(value) == nullptr ? "nullptr" : "true");
            if (std::get<223>(value) != nullptr)
            {
                stream << "->" << *std::get<223>(value);
            }
            break;
        case 224:
            stream<< "{Null*}";
            stream << "ptr of other struct: " << (std::get<224>(value) == nullptr ? "nullptr" : "true");
            if (std::get<224>(value) != nullptr)
            {
                stream << "->" << *std::get<224>(value);
            }
            break;
        case 225:
            stream<< "{List*}";
            stream << "ptr of other struct: " << (std::get<225>(value) == nullptr ? "nullptr" : "true");
            if (std::get<225>(value) != nullptr)
            {
                stream << "->" << *std::get<225>(value);
            }
            break;
        case 226:
            stream<< "{IntList*}";
            stream << "ptr of other struct: " << (std::get<226>(value) == nullptr ? "nullptr" : "true");
            if (std::get<226>(value) != nullptr)
            {
                stream << "->" << *std::get<226>(value);
            }
            break;
        case 227:
            stream<< "{OidList*}";
            stream << "ptr of other struct: " << (std::get<227>(value) == nullptr ? "nullptr" : "true");
            if (std::get<227>(value) != nullptr)
            {
                stream << "->" << *std::get<227>(value);
            }
            break;
        default:
...
Integer::Integer([[maybe_unused]] Integer&& other) noexcept
...
void Integer::swap([[maybe_unused]] Integer& other) noexcept
{
    using std::swap;
...
Float::Float([[maybe_unused]] Float&& other) noexcept
...
void Float::swap([[maybe_unused]] Float& other) noexcept
{
    using std::swap;
    swap(str, other.str);
}
...
String::String([[maybe_unused]] String&& other) noexcept
    : str(std::move(other.str))
{}
...
void String::swap([[maybe_unused]] String& other) noexcept
{
    using std::swap;
    swap(str, other.str);
}
...
BitString::BitString([[maybe_unused]] BitString&& other) noexcept
    : str(std::move(other.str))
{}
...
void BitString::swap([[maybe_unused]] BitString& other) noexcept
{
    using std::swap;
    swap(str, other.str);
}
...
Null::Null([[maybe_unused]] Null&& other) noexcept
{}
...
void Null::swap([[maybe_unused]] Null& other) noexcept
{
    using std::swap;
}
...
List::List([[maybe_unused]] List&& other) noexcept
...
void List::swap([[maybe_unused]] List& other) noexcept
{
    using std::swap;
...
OidList::OidList([[maybe_unused]] OidList&& other) noexcept
    : items(std::move(other.items))
{}
...
void OidList::swap([[maybe_unused]] OidList& other) noexcept
{
    using std::swap;
    swap(items, other.items);
}
...
IntList::IntList([[maybe_unused]] IntList&& other) noexcept
    : items(std::move(other.items))
{}
...
void IntList::swap([[maybe_unused]] IntList& other) noexcept
{
    using std::swap;
    swap(items, other.items);
}
...
Alias::Alias([[maybe_unused]] Alias&& other) noexcept
...
RangeVar::RangeVar([[maybe_unused]] RangeVar&& other) noexcept
...
void RangeVar::swap([[maybe_unused]] RangeVar& other) noexcept
{
    using std::swap;
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const RangeVar& value)
{
    ...
    stream << ",alias="; stream << "ptr of other struct: " << (value.alias == nullptr ? "nullptr" : "true");
...
TableFunc::TableFunc([[maybe_unused]] TableFunc&& other) noexcept
...
void TableFunc::swap([[maybe_unused]] TableFunc& other) noexcept
{
    using std::swap;
...
Expr::Expr([[maybe_unused]] Expr&& other) noexcept
{}
...
void Expr::swap([[maybe_unused]] Expr& other) noexcept
{
    using std::swap;
}
...
Var::Var([[maybe_unused]] Var&& other) noexcept
...
void Var::swap([[maybe_unused]] Var& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
Param::Param([[maybe_unused]] Param&& other) noexcept
    : xpr(std::move(other.xpr))
...
void Param::swap([[maybe_unused]] Param& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
Aggref::Aggref([[maybe_unused]] Aggref&& other) noexcept
    : xpr(std::move(other.xpr))
...
void Aggref::swap([[maybe_unused]] Aggref& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
GroupingFunc::GroupingFunc([[maybe_unused]] GroupingFunc&& other) noexcept
    : xpr(std::move(other.xpr))
    , args(std::move(other.args))
...
void GroupingFunc::swap([[maybe_unused]] GroupingFunc& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(args, other.args);
...
WindowFunc::WindowFunc([[maybe_unused]] WindowFunc&& other) noexcept
    : xpr(std::move(other.xpr))
...
void WindowFunc::swap([[maybe_unused]] WindowFunc& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
SubscriptingRef::SubscriptingRef([[maybe_unused]] SubscriptingRef&& other) noexcept
    : xpr(std::move(other.xpr))
...
void SubscriptingRef::swap([[maybe_unused]] SubscriptingRef& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
FuncExpr::FuncExpr([[maybe_unused]] FuncExpr&& other) noexcept
    : xpr(std::move(other.xpr))
...
void FuncExpr::swap([[maybe_unused]] FuncExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
NamedArgExpr::NamedArgExpr([[maybe_unused]] NamedArgExpr&& other) noexcept
    : xpr(std::move(other.xpr))
...
void NamedArgExpr::swap([[maybe_unused]] NamedArgExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(arg, other.arg);
...
OpExpr::OpExpr([[maybe_unused]] OpExpr&& other) noexcept
    : xpr(std::move(other.xpr))
...
void OpExpr::swap([[maybe_unused]] OpExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
DistinctExpr::DistinctExpr([[maybe_unused]] DistinctExpr&& other) noexcept
    : xpr(std::move(other.xpr))
    , opno(std::exchange(other.opno, (uint32_t)0ull))
    , opfuncid(std::exchange(other.opfuncid, (uint32_t)0ull))
    , opresulttype(std::exchange(other.opresulttype, (uint32_t)0ull))
...
void DistinctExpr::swap([[maybe_unused]] DistinctExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(opno, other.opno);
...
NullIfExpr::NullIfExpr([[maybe_unused]] NullIfExpr&& other) noexcept
    : xpr(std::move(other.xpr))
    , opno(std::exchange(other.opno, (uint32_t)0ull))
    , opfuncid(std::exchange(other.opfuncid, (uint32_t)0ull))
    , opresulttype(std::exchange(other.opresulttype, (uint32_t)0ull))
...
void NullIfExpr::swap([[maybe_unused]] NullIfExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(opno, other.opno);
...
ScalarArrayOpExpr::ScalarArrayOpExpr([[maybe_unused]] ScalarArrayOpExpr&& other) noexcept
    : xpr(std::move(other.xpr))
    , opno(std::exchange(other.opno, (uint32_t)0ull))
    , opfuncid(std::exchange(other.opfuncid, (uint32_t)0ull))
...
void ScalarArrayOpExpr::swap([[maybe_unused]] ScalarArrayOpExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(opno, other.opno);
...
BoolExpr::BoolExpr([[maybe_unused]] BoolExpr&& other) noexcept
    : xpr(std::move(other.xpr))
...
void BoolExpr::swap([[maybe_unused]] BoolExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
SubLink::SubLink([[maybe_unused]] SubLink&& other) noexcept
    : xpr(std::move(other.xpr))
...
void SubLink::swap([[maybe_unused]] SubLink& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
SubPlan::SubPlan([[maybe_unused]] SubPlan&& other) noexcept
    : xpr(std::move(other.xpr))
    , sub_link_type(std::move(other.sub_link_type))
    , testexpr(std::move(other.testexpr))
...
void SubPlan::swap([[maybe_unused]] SubPlan& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(sub_link_type, other.sub_link_type);
...
AlternativeSubPlan::AlternativeSubPlan([[maybe_unused]] AlternativeSubPlan&& other) noexcept
    : xpr(std::move(other.xpr))
...
void AlternativeSubPlan::swap([[maybe_unused]] AlternativeSubPlan& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
FieldSelect::FieldSelect([[maybe_unused]] FieldSelect&& other) noexcept
    : xpr(std::move(other.xpr))
    , arg(std::move(other.arg))
...
void FieldSelect::swap([[maybe_unused]] FieldSelect& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(arg, other.arg);
...
FieldStore::FieldStore([[maybe_unused]] FieldStore&& other) noexcept
    : xpr(std::move(other.xpr))
    , arg(std::move(other.arg))
...
void FieldStore::swap([[maybe_unused]] FieldStore& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(arg, other.arg);
...
RelabelType::RelabelType([[maybe_unused]] RelabelType&& other) noexcept
    : xpr(std::move(other.xpr))
    , arg(std::move(other.arg))
    , resulttype(std::exchange(other.resulttype, (uint32_t)0ull))
    , resulttypmod(std::exchange(other.resulttypmod, (int32_t)0ll))
...
void RelabelType::swap([[maybe_unused]] RelabelType& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(arg, other.arg);
...
CoerceViaIO::CoerceViaIO([[maybe_unused]] CoerceViaIO&& other) noexcept
    : xpr(std::move(other.xpr))
    , arg(std::move(other.arg))
    , resulttype(std::exchange(other.resulttype, (uint32_t)0ull))
    , resultcollid(std::exchange(other.resultcollid, (uint32_t)0ull))
...
void CoerceViaIO::swap([[maybe_unused]] CoerceViaIO& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(arg, other.arg);
...
ArrayCoerceExpr::ArrayCoerceExpr([[maybe_unused]] ArrayCoerceExpr&& other) noexcept
    : xpr(std::move(other.xpr))
    , arg(std::move(other.arg))
...
void ArrayCoerceExpr::swap([[maybe_unused]] ArrayCoerceExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(arg, other.arg);
...
ConvertRowtypeExpr::ConvertRowtypeExpr([[maybe_unused]] ConvertRowtypeExpr&& other) noexcept
    : xpr(std::move(other.xpr))
    , arg(std::move(other.arg))
    , resulttype(std::exchange(other.resulttype, (uint32_t)0ull))
...
void ConvertRowtypeExpr::swap([[maybe_unused]] ConvertRowtypeExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(arg, other.arg);
...
CollateExpr::CollateExpr([[maybe_unused]] CollateExpr&& other) noexcept
    : xpr(std::move(other.xpr))
    , arg(std::move(other.arg))
...
void CollateExpr::swap([[maybe_unused]] CollateExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(arg, other.arg);
...
CaseExpr::CaseExpr([[maybe_unused]] CaseExpr&& other) noexcept
    : xpr(std::move(other.xpr))
...
void CaseExpr::swap([[maybe_unused]] CaseExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
CaseWhen::CaseWhen([[maybe_unused]] CaseWhen&& other) noexcept
    : xpr(std::move(other.xpr))
...
void CaseWhen::swap([[maybe_unused]] CaseWhen& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
CaseTestExpr::CaseTestExpr([[maybe_unused]] CaseTestExpr&& other) noexcept
    : xpr(std::move(other.xpr))
...
void CaseTestExpr::swap([[maybe_unused]] CaseTestExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
ArrayExpr::ArrayExpr([[maybe_unused]] ArrayExpr&& other) noexcept
    : xpr(std::move(other.xpr))
...
void ArrayExpr::swap([[maybe_unused]] ArrayExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
RowExpr::RowExpr([[maybe_unused]] RowExpr&& other) noexcept
    : xpr(std::move(other.xpr))
    , args(std::move(other.args))
...
void RowExpr::swap([[maybe_unused]] RowExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(args, other.args);
...
RowCompareExpr::RowCompareExpr([[maybe_unused]] RowCompareExpr&& other) noexcept
    : xpr(std::move(other.xpr))
...
void RowCompareExpr::swap([[maybe_unused]] RowCompareExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
CoalesceExpr::CoalesceExpr([[maybe_unused]] CoalesceExpr&& other) noexcept
    : xpr(std::move(other.xpr))
...
void CoalesceExpr::swap([[maybe_unused]] CoalesceExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
MinMaxExpr::MinMaxExpr([[maybe_unused]] MinMaxExpr&& other) noexcept
    : xpr(std::move(other.xpr))
...
void MinMaxExpr::swap([[maybe_unused]] MinMaxExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
SQLValueFunction::SQLValueFunction([[maybe_unused]] SQLValueFunction&& other) noexcept
    : xpr(std::move(other.xpr))
    , op(std::move(other.op))
...
void SQLValueFunction::swap([[maybe_unused]] SQLValueFunction& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(op, other.op);
...
XmlExpr::XmlExpr([[maybe_unused]] XmlExpr&& other) noexcept
    : xpr(std::move(other.xpr))
    , op(std::move(other.op))
    , name(std::move(other.name))
...
void XmlExpr::swap([[maybe_unused]] XmlExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(op, other.op);
...
NullTest::NullTest([[maybe_unused]] NullTest&& other) noexcept
    : xpr(std::move(other.xpr))
    , arg(std::move(other.arg))
...
void NullTest::swap([[maybe_unused]] NullTest& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(arg, other.arg);
...
BooleanTest::BooleanTest([[maybe_unused]] BooleanTest&& other) noexcept
    : xpr(std::move(other.xpr))
    , arg(std::move(other.arg))
...
void BooleanTest::swap([[maybe_unused]] BooleanTest& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(arg, other.arg);
...
CoerceToDomain::CoerceToDomain([[maybe_unused]] CoerceToDomain&& other) noexcept
    : xpr(std::move(other.xpr))
    , arg(std::move(other.arg))
    , resulttype(std::exchange(other.resulttype, (uint32_t)0ull))
    , resulttypmod(std::exchange(other.resulttypmod, (int32_t)0ll))
...
void CoerceToDomain::swap([[maybe_unused]] CoerceToDomain& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(arg, other.arg);
...
CoerceToDomainValue::CoerceToDomainValue([[maybe_unused]] CoerceToDomainValue&& other) noexcept
    : xpr(std::move(other.xpr))
    , type_id(std::exchange(other.type_id, (uint32_t)0ull))
    , type_mod(std::exchange(other.type_mod, (int32_t)0ll))
    , collation(std::exchange(other.collation, (uint32_t)0ull))
...
void CoerceToDomainValue::swap([[maybe_unused]] CoerceToDomainValue& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(type_id, other.type_id);
...
SetToDefault::SetToDefault([[maybe_unused]] SetToDefault&& other) noexcept
    : xpr(std::move(other.xpr))
    , type_id(std::exchange(other.type_id, (uint32_t)0ull))
    , type_mod(std::exchange(other.type_mod, (int32_t)0ll))
    , collation(std::exchange(other.collation, (uint32_t)0ull))
...
void SetToDefault::swap([[maybe_unused]] SetToDefault& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(type_id, other.type_id);
...
CurrentOfExpr::CurrentOfExpr([[maybe_unused]] CurrentOfExpr&& other) noexcept
    : xpr(std::move(other.xpr))
...
void CurrentOfExpr::swap([[maybe_unused]] CurrentOfExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
NextValueExpr::NextValueExpr([[maybe_unused]] NextValueExpr&& other) noexcept
    : xpr(std::move(other.xpr))
...
void NextValueExpr::swap([[maybe_unused]] NextValueExpr& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
...
InferenceElem::InferenceElem([[maybe_unused]] InferenceElem&& other) noexcept
    : xpr(std::move(other.xpr))
    , expr(std::move(other.expr))
...
void InferenceElem::swap([[maybe_unused]] InferenceElem& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(expr, other.expr);
...
TargetEntry::TargetEntry([[maybe_unused]] TargetEntry&& other) noexcept
    : xpr(std::move(other.xpr))
    , expr(std::move(other.expr))
...
void TargetEntry::swap([[maybe_unused]] TargetEntry& other) noexcept
{
    using std::swap;
    swap(xpr, other.xpr);
    swap(expr, other.expr);
...
RangeTblRef::RangeTblRef([[maybe_unused]] RangeTblRef&& other) noexcept
...
void RangeTblRef::swap([[maybe_unused]] RangeTblRef& other) noexcept
{
    using std::swap;
...
JoinExpr::JoinExpr([[maybe_unused]] JoinExpr&& other) noexcept
...
void JoinExpr::swap([[maybe_unused]] JoinExpr& other) noexcept
{
    using std::swap;
...
FromExpr::FromExpr([[maybe_unused]] FromExpr&& other) noexcept
...
void FromExpr::swap([[maybe_unused]] FromExpr& other) noexcept
{
    using std::swap;
...
OnConflictExpr::OnConflictExpr([[maybe_unused]] OnConflictExpr&& other) noexcept
...
void OnConflictExpr::swap([[maybe_unused]] OnConflictExpr& other) noexcept
{
    using std::swap;
...
IntoClause::IntoClause([[maybe_unused]] IntoClause&& other) noexcept
...
void IntoClause::swap([[maybe_unused]] IntoClause& other) noexcept
{
    using std::swap;
    swap(rel, other.rel);
...
{
    stream << "IntoClause(";
    stream << "rel="; stream << "ptr of other struct: " << (value.rel == nullptr ? "nullptr" : "true");
    {
        bool first = true;
...
RawStmt::RawStmt([[maybe_unused]] RawStmt&& other) noexcept
...
void RawStmt::swap([[maybe_unused]] RawStmt& other) noexcept
{
    using std::swap;
...
Query::Query([[maybe_unused]] Query&& other) noexcept
...
void Query::swap([[maybe_unused]] Query& other) noexcept
{
    using std::swap;
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const Query& value)
{
    ...
    stream << ",jointree="; stream << "ptr of other struct: " << (value.jointree == nullptr ? "nullptr" : "true");
    {
        bool first = true;
    ...
    stream << ",on_conflict="; stream << "ptr of other struct: " << (value.on_conflict == nullptr ? "nullptr" : "true");
    {
        bool first = true;
...
InsertStmt::InsertStmt([[maybe_unused]] InsertStmt&& other) noexcept
...
void InsertStmt::swap([[maybe_unused]] InsertStmt& other) noexcept
{
    using std::swap;
...
{
    stream << "InsertStmt(";
    stream << "relation="; stream << "ptr of other struct: " << (value.relation == nullptr ? "nullptr" : "true");
    {
        bool first = true;
        stream << ",cols=[" << value.cols.size() << "][";
        for (const auto& it : value.cols)
    ...
    stream << ",on_conflict_clause="; stream << "ptr of other struct: " << (value.on_conflict_clause == nullptr ? "nullptr" : "true");
    {
        bool first = true;
        stream << ",returning_list=[" << value.returning_list.size() << "][";
        for (const auto& it : value.returning_list)
    ...
    stream << ",with_clause="; stream << "ptr of other struct: " << (value.with_clause == nullptr ? "nullptr" : "true");
    stream << ",override="; stream << value.override;
    stream << ")";
    return stream;
}
...
DeleteStmt::DeleteStmt([[maybe_unused]] DeleteStmt&& other) noexcept
    : relation(std::exchange(other.relation, nullptr))
    , using_clause(std::move(other.using_clause))
...
void DeleteStmt::swap([[maybe_unused]] DeleteStmt& other) noexcept
{
    using std::swap;
    swap(relation, other.relation);
    swap(using_clause, other.using_clause);
...
UpdateStmt::UpdateStmt([[maybe_unused]] UpdateStmt&& other) noexcept
    : relation(std::exchange(other.relation, nullptr))
    , target_list(std::move(other.target_list))
    , where_clause(std::move(other.where_clause))
...
void UpdateStmt::swap([[maybe_unused]] UpdateStmt& other) noexcept
{
    using std::swap;
    swap(relation, other.relation);
    swap(target_list, other.target_list);
...
SelectStmt::SelectStmt([[maybe_unused]] SelectStmt&& other) noexcept
    : distinct_clause(std::move(other.distinct_clause))
...
void SelectStmt::swap([[maybe_unused]] SelectStmt& other) noexcept
{
    using std::swap;
    swap(distinct_clause, other.distinct_clause);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const SelectStmt& value)
{
    ...
    stream << ",into_clause="; stream << "ptr of other struct: " << (value.into_clause == nullptr ? "nullptr" : "true");
    {
        bool first = true;
        stream << ",target_list=[" << value.target_list.size() << "][";
        for (const auto& it : value.target_list)
    ...
    stream << ",larg="; stream << "ptr of other struct: " << (value.larg == nullptr ? "nullptr" : "true");
    stream << ",rarg="; stream << "ptr of other struct: " << (value.rarg == nullptr ? "nullptr" : "true");
    stream << ")";
    return stream;
}
...
AlterTableStmt::AlterTableStmt([[maybe_unused]] AlterTableStmt&& other) noexcept
    : relation(std::exchange(other.relation, nullptr))
...
void AlterTableStmt::swap([[maybe_unused]] AlterTableStmt& other) noexcept
{
    using std::swap;
    swap(relation, other.relation);
...
AlterTableCmd::AlterTableCmd([[maybe_unused]] AlterTableCmd&& other) noexcept
...
void AlterTableCmd::swap([[maybe_unused]] AlterTableCmd& other) noexcept
{
    using std::swap;
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const AlterTableCmd& value)
{
    ...
    stream << ",newowner="; stream << "ptr of other struct: " << (value.newowner == nullptr ? "nullptr" : "true");
...
AlterDomainStmt::AlterDomainStmt([[maybe_unused]] AlterDomainStmt&& other) noexcept
    : subtype(std::move(other.subtype))
...
void AlterDomainStmt::swap([[maybe_unused]] AlterDomainStmt& other) noexcept
{
    using std::swap;
    swap(subtype, other.subtype);
...
SetOperationStmt::SetOperationStmt([[maybe_unused]] SetOperationStmt&& other) noexcept
    : op(std::move(other.op))
    , all(std::exchange(other.all, false))
    , larg(std::move(other.larg))
    , rarg(std::move(other.rarg))
...
void SetOperationStmt::swap([[maybe_unused]] SetOperationStmt& other) noexcept
{
    using std::swap;
    swap(op, other.op);
    swap(all, other.all);
...
GrantStmt::GrantStmt([[maybe_unused]] GrantStmt&& other) noexcept
...
void GrantStmt::swap([[maybe_unused]] GrantStmt& other) noexcept
{
    using std::swap;
...
GrantRoleStmt::GrantRoleStmt([[maybe_unused]] GrantRoleStmt&& other) noexcept
...
void GrantRoleStmt::swap([[maybe_unused]] GrantRoleStmt& other) noexcept
{
    using std::swap;
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const GrantRoleStmt& value)
{
    ...
    stream << ",grantor="; stream << "ptr of other struct: " << (value.grantor == nullptr ? "nullptr" : "true");
    stream << ",behavior="; stream << value.behavior;
    stream << ")";
    return stream;
}
...
AlterDefaultPrivilegesStmt::AlterDefaultPrivilegesStmt([[maybe_unused]] AlterDefaultPrivilegesStmt&& other) noexcept
    : options(std::move(other.options))
...
void AlterDefaultPrivilegesStmt::swap([[maybe_unused]] AlterDefaultPrivilegesStmt& other) noexcept
{
    using std::swap;
    swap(options, other.options);
    swap(action, other.action);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const AlterDefaultPrivilegesStmt& value)
{
    ...
    stream << ",action="; stream << "ptr of other struct: " << (value.action == nullptr ? "nullptr" : "true");
    stream << ")";
    return stream;
}
...
ClosePortalStmt::ClosePortalStmt([[maybe_unused]] ClosePortalStmt&& other) noexcept
...
void ClosePortalStmt::swap([[maybe_unused]] ClosePortalStmt& other) noexcept
{
    using std::swap;
...
ClusterStmt::ClusterStmt([[maybe_unused]] ClusterStmt&& other) noexcept
    : relation(std::exchange(other.relation, nullptr))
...
void ClusterStmt::swap([[maybe_unused]] ClusterStmt& other) noexcept
{
    using std::swap;
    swap(relation, other.relation);
...
CopyStmt::CopyStmt([[maybe_unused]] CopyStmt&& other) noexcept
    : relation(std::exchange(other.relation, nullptr))
...
void CopyStmt::swap([[maybe_unused]] CopyStmt& other) noexcept
{
    using std::swap;
    swap(relation, other.relation);
...
CreateStmt::CreateStmt([[maybe_unused]] CreateStmt&& other) noexcept
    : relation(std::exchange(other.relation, nullptr))
...
void CreateStmt::swap([[maybe_unused]] CreateStmt& other) noexcept
{
    using std::swap;
    swap(relation, other.relation);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const CreateStmt& value)
{
    ...
    stream << ",partbound="; stream << "ptr of other struct: " << (value.partbound == nullptr ? "nullptr" : "true");
    stream << ",partspec="; stream << "ptr of other struct: " << (value.partspec == nullptr ? "nullptr" : "true");
    stream << ",of_typename="; stream << "ptr of other struct: " << (value.of_typename == nullptr ? "nullptr" : "true");
    {
        bool first = true;
...
DefineStmt::DefineStmt([[maybe_unused]] DefineStmt&& other) noexcept
...
void DefineStmt::swap([[maybe_unused]] DefineStmt& other) noexcept
{
    using std::swap;
...
DropStmt::DropStmt([[maybe_unused]] DropStmt&& other) noexcept
    : objects(std::move(other.objects))
...
void DropStmt::swap([[maybe_unused]] DropStmt& other) noexcept
{
    using std::swap;
    swap(objects, other.objects);
...
TruncateStmt::TruncateStmt([[maybe_unused]] TruncateStmt&& other) noexcept
...
void TruncateStmt::swap([[maybe_unused]] TruncateStmt& other) noexcept
{
    using std::swap;
...
CommentStmt::CommentStmt([[maybe_unused]] CommentStmt&& other) noexcept
    : objtype(std::move(other.objtype))
...
void CommentStmt::swap([[maybe_unused]] CommentStmt& other) noexcept
{
    using std::swap;
    swap(objtype, other.objtype);
...
FetchStmt::FetchStmt([[maybe_unused]] FetchStmt&& other) noexcept
...
void FetchStmt::swap([[maybe_unused]] FetchStmt& other) noexcept
{
    using std::swap;
...
IndexStmt::IndexStmt([[maybe_unused]] IndexStmt&& other) noexcept
...
void IndexStmt::swap([[maybe_unused]] IndexStmt& other) noexcept
{
    using std::swap;
...
CreateFunctionStmt::CreateFunctionStmt([[maybe_unused]] CreateFunctionStmt&& other) noexcept
...
void CreateFunctionStmt::swap([[maybe_unused]] CreateFunctionStmt& other) noexcept
{
    using std::swap;
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const CreateFunctionStmt& value)
{
    ...
    stream << ",return_type="; stream << "ptr of other struct: " << (value.return_type == nullptr ? "nullptr" : "true");
    {
        bool first = true;
        stream << ",options=[" << value.options.size() << "][";
        for (const auto& it : value.options)
...
AlterFunctionStmt::AlterFunctionStmt([[maybe_unused]] AlterFunctionStmt&& other) noexcept
    : objtype(std::move(other.objtype))
...
void AlterFunctionStmt::swap([[maybe_unused]] AlterFunctionStmt& other) noexcept
{
    using std::swap;
    swap(objtype, other.objtype);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const AlterFunctionStmt& value)
{
    stream << "AlterFunctionStmt(";
    stream << "objtype="; stream << value.objtype;
    stream << ",func="; stream << "ptr of other struct: " << (value.func == nullptr ? "nullptr" : "true");
    {
        bool first = true;
...
DoStmt::DoStmt([[maybe_unused]] DoStmt&& other) noexcept
    : args(std::move(other.args))
{}
...
void DoStmt::swap([[maybe_unused]] DoStmt& other) noexcept
{
    using std::swap;
    swap(args, other.args);
}
...
RenameStmt::RenameStmt([[maybe_unused]] RenameStmt&& other) noexcept
...
void RenameStmt::swap([[maybe_unused]] RenameStmt& other) noexcept
{
    using std::swap;
...
RuleStmt::RuleStmt([[maybe_unused]] RuleStmt&& other) noexcept
    : relation(std::exchange(other.relation, nullptr))
...
void RuleStmt::swap([[maybe_unused]] RuleStmt& other) noexcept
{
    using std::swap;
    swap(relation, other.relation);
...
NotifyStmt::NotifyStmt([[maybe_unused]] NotifyStmt&& other) noexcept
...
void NotifyStmt::swap([[maybe_unused]] NotifyStmt& other) noexcept
{
    using std::swap;
...
ListenStmt::ListenStmt([[maybe_unused]] ListenStmt&& other) noexcept
    : conditionname(std::move(other.conditionname))
{}
...
void ListenStmt::swap([[maybe_unused]] ListenStmt& other) noexcept
{
    using std::swap;
    swap(conditionname, other.conditionname);
}
...
UnlistenStmt::UnlistenStmt([[maybe_unused]] UnlistenStmt&& other) noexcept
    : conditionname(std::move(other.conditionname))
{}
...
void UnlistenStmt::swap([[maybe_unused]] UnlistenStmt& other) noexcept
{
    using std::swap;
    swap(conditionname, other.conditionname);
}
...
TransactionStmt::TransactionStmt([[maybe_unused]] TransactionStmt&& other) noexcept
    : kind(std::move(other.kind))
    , options(std::move(other.options))
...
void TransactionStmt::swap([[maybe_unused]] TransactionStmt& other) noexcept
{
    using std::swap;
    swap(kind, other.kind);
    swap(options, other.options);
...
ViewStmt::ViewStmt([[maybe_unused]] ViewStmt&& other) noexcept
...
void ViewStmt::swap([[maybe_unused]] ViewStmt& other) noexcept
{
    using std::swap;
...
{
    stream << "ViewStmt(";
    stream << "view="; stream << "ptr of other struct: " << (value.view == nullptr ? "nullptr" : "true");
    {
        bool first = true;
...
LoadStmt::LoadStmt([[maybe_unused]] LoadStmt&& other) noexcept
    : filename(std::move(other.filename))
{}
...
void LoadStmt::swap([[maybe_unused]] LoadStmt& other) noexcept
{
    using std::swap;
    swap(filename, other.filename);
}
...
CreateDomainStmt::CreateDomainStmt([[maybe_unused]] CreateDomainStmt&& other) noexcept
...
void CreateDomainStmt::swap([[maybe_unused]] CreateDomainStmt& other) noexcept
{
    using std::swap;
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const CreateDomainStmt& value)
{
    ...
    stream << ",type_name="; stream << "ptr of other struct: " << (value.type_name == nullptr ? "nullptr" : "true");
    stream << ",coll_clause="; stream << "ptr of other struct: " << (value.coll_clause == nullptr ? "nullptr" : "true");
    {
        bool first = true;
        stream << ",constraints=[" << value.constraints.size() << "][";
        for (const auto& it : value.constraints)
...
CreatedbStmt::CreatedbStmt([[maybe_unused]] CreatedbStmt&& other) noexcept
...
void CreatedbStmt::swap([[maybe_unused]] CreatedbStmt& other) noexcept
{
    using std::swap;
...
DropdbStmt::DropdbStmt([[maybe_unused]] DropdbStmt&& other) noexcept
    : dbname(std::move(other.dbname))
    , missing_ok(std::exchange(other.missing_ok, false))
    , options(std::move(other.options))
{}
...
void DropdbStmt::swap([[maybe_unused]] DropdbStmt& other) noexcept
{
    using std::swap;
    swap(dbname, other.dbname);
    swap(missing_ok, other.missing_ok);
...
VacuumStmt::VacuumStmt([[maybe_unused]] VacuumStmt&& other) noexcept
    : options(std::move(other.options))
...
void VacuumStmt::swap([[maybe_unused]] VacuumStmt& other) noexcept
{
    using std::swap;
    swap(options, other.options);
...
ExplainStmt::ExplainStmt([[maybe_unused]] ExplainStmt&& other) noexcept
    : query(std::move(other.query))
    , options(std::move(other.options))
{}
...
void ExplainStmt::swap([[maybe_unused]] ExplainStmt& other) noexcept
{
    using std::swap;
    swap(query, other.query);
    swap(options, other.options);
...
CreateTableAsStmt::CreateTableAsStmt([[maybe_unused]] CreateTableAsStmt&& other) noexcept
    : query(std::move(other.query))
...
void CreateTableAsStmt::swap([[maybe_unused]] CreateTableAsStmt& other) noexcept
{
    using std::swap;
    swap(query, other.query);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const CreateTableAsStmt& value)
{
    stream << "CreateTableAsStmt(";
    stream << "query="; stream << value.query;
    stream << ",into="; stream << "ptr of other struct: " << (value.into == nullptr ? "nullptr" : "true");
    stream << ",relkind="; stream << value.relkind;
...
CreateSeqStmt::CreateSeqStmt([[maybe_unused]] CreateSeqStmt&& other) noexcept
...
void CreateSeqStmt::swap([[maybe_unused]] CreateSeqStmt& other) noexcept
{
    using std::swap;
...
{
    stream << "CreateSeqStmt(";
    stream << "sequence="; stream << "ptr of other struct: " << (value.sequence == nullptr ? "nullptr" : "true");
    {
        bool first = true;
        stream << ",options=[" << value.options.size() << "][";
        for (const auto& it : value.options)
...
AlterSeqStmt::AlterSeqStmt([[maybe_unused]] AlterSeqStmt&& other) noexcept
    : sequence(std::exchange(other.sequence, nullptr))
    , options(std::move(other.options))
    , for_identity(std::exchange(other.for_identity, false))
    , missing_ok(std::exchange(other.missing_ok, false))
...
void AlterSeqStmt::swap([[maybe_unused]] AlterSeqStmt& other) noexcept
{
    using std::swap;
    swap(sequence, other.sequence);
    swap(options, other.options);
...
VariableSetStmt::VariableSetStmt([[maybe_unused]] VariableSetStmt&& other) noexcept
    : kind(std::move(other.kind))
    , name(std::move(other.name))
    , args(std::move(other.args))
...
void VariableSetStmt::swap([[maybe_unused]] VariableSetStmt& other) noexcept
{
    using std::swap;
    swap(kind, other.kind);
    swap(name, other.name);
...
VariableShowStmt::VariableShowStmt([[maybe_unused]] VariableShowStmt&& other) noexcept
    : name(std::move(other.name))
{}
...
void VariableShowStmt::swap([[maybe_unused]] VariableShowStmt& other) noexcept
{
    using std::swap;
    swap(name, other.name);
}
...
DiscardStmt::DiscardStmt([[maybe_unused]] DiscardStmt&& other) noexcept
...
void DiscardStmt::swap([[maybe_unused]] DiscardStmt& other) noexcept
{
    using std::swap;
...
CreateTrigStmt::CreateTrigStmt([[maybe_unused]] CreateTrigStmt&& other) noexcept
...
void CreateTrigStmt::swap([[maybe_unused]] CreateTrigStmt& other) noexcept
{
    using std::swap;
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const CreateTrigStmt& value)
{
    ...
    stream << ",deferrable="; stream << (value.deferrable ? "true" : "false");
    stream << ",initdeferred="; stream << (value.initdeferred ? "true" : "false");
    stream << ",constrrel="; stream << "ptr of other struct: " << (value.constrrel == nullptr ? "nullptr" : "true");
    stream << ")";
    return stream;
}
...
CreatePLangStmt::CreatePLangStmt([[maybe_unused]] CreatePLangStmt&& other) noexcept
    : replace(std::exchange(other.replace, false))
...
void CreatePLangStmt::swap([[maybe_unused]] CreatePLangStmt& other) noexcept
{
    using std::swap;
    swap(replace, other.replace);
...
CreateRoleStmt::CreateRoleStmt([[maybe_unused]] CreateRoleStmt&& other) noexcept
...
void CreateRoleStmt::swap([[maybe_unused]] CreateRoleStmt& other) noexcept
{
    using std::swap;
...
AlterRoleStmt::AlterRoleStmt([[maybe_unused]] AlterRoleStmt&& other) noexcept
...
void AlterRoleStmt::swap([[maybe_unused]] AlterRoleStmt& other) noexcept
{
    using std::swap;
    swap(role, other.role);
    swap(options, other.options);
...
{
    stream << "AlterRoleStmt(";
    stream << "role="; stream << "ptr of other struct: " << (value.role == nullptr ? "nullptr" : "true");
    {
        bool first = true;
        stream << ",options=[" << value.options.size() << "][";
        for (const auto& it : value.options)
...
DropRoleStmt::DropRoleStmt([[maybe_unused]] DropRoleStmt&& other) noexcept
...
void DropRoleStmt::swap([[maybe_unused]] DropRoleStmt& other) noexcept
{
    using std::swap;
...
LockStmt::LockStmt([[maybe_unused]] LockStmt&& other) noexcept
    : relations(std::move(other.relations))
...
void LockStmt::swap([[maybe_unused]] LockStmt& other) noexcept
{
    using std::swap;
    swap(relations, other.relations);
...
ConstraintsSetStmt::ConstraintsSetStmt([[maybe_unused]] ConstraintsSetStmt&& other) noexcept
    : constraints(std::move(other.constraints))
...
void ConstraintsSetStmt::swap([[maybe_unused]] ConstraintsSetStmt& other) noexcept
{
    using std::swap;
    swap(constraints, other.constraints);
...
ReindexStmt::ReindexStmt([[maybe_unused]] ReindexStmt&& other) noexcept
    : kind(std::move(other.kind))
    , relation(std::exchange(other.relation, nullptr))
    , name(std::move(other.name))
    , options(std::exchange(other.options, (int32_t)0ll))
...
void ReindexStmt::swap([[maybe_unused]] ReindexStmt& other) noexcept
{
    using std::swap;
    swap(kind, other.kind);
    swap(relation, other.relation);
...
CheckPointStmt::CheckPointStmt([[maybe_unused]] CheckPointStmt&& other) noexcept
{}
...
void CheckPointStmt::swap([[maybe_unused]] CheckPointStmt& other) noexcept
{
    using std::swap;
}
...
CreateSchemaStmt::CreateSchemaStmt([[maybe_unused]] CreateSchemaStmt&& other) noexcept
    : schemaname(std::move(other.schemaname))
...
void CreateSchemaStmt::swap([[maybe_unused]] CreateSchemaStmt& other) noexcept
{
    using std::swap;
    swap(schemaname, other.schemaname);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const CreateSchemaStmt& value)
{
    stream << "CreateSchemaStmt(";
    stream << "schemaname="; stream << "\"" << value.schemaname << "\"";
    stream << ",authrole="; stream << "ptr of other struct: " << (value.authrole == nullptr ? "nullptr" : "true");
    {
        bool first = true;
...
AlterDatabaseStmt::AlterDatabaseStmt([[maybe_unused]] AlterDatabaseStmt&& other) noexcept
    : dbname(std::move(other.dbname))
    , options(std::move(other.options))
{}
...
void AlterDatabaseStmt::swap([[maybe_unused]] AlterDatabaseStmt& other) noexcept
{
    using std::swap;
    swap(dbname, other.dbname);
    swap(options, other.options);
...
AlterDatabaseSetStmt::AlterDatabaseSetStmt([[maybe_unused]] AlterDatabaseSetStmt&& other) noexcept
    : dbname(std::move(other.dbname))
...
void AlterDatabaseSetStmt::swap([[maybe_unused]] AlterDatabaseSetStmt& other) noexcept
{
    using std::swap;
    swap(dbname, other.dbname);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const AlterDatabaseSetStmt& value)
{
    stream << "AlterDatabaseSetStmt(";
    stream << "dbname="; stream << "\"" << value.dbname << "\"";
    stream << ",setstmt="; stream << "ptr of other struct: " << (value.setstmt == nullptr ? "nullptr" : "true");
    stream << ")";
    return stream;
}
...
AlterRoleSetStmt::AlterRoleSetStmt([[maybe_unused]] AlterRoleSetStmt&& other) noexcept
    : role(std::exchange(other.role, nullptr))
...
void AlterRoleSetStmt::swap([[maybe_unused]] AlterRoleSetStmt& other) noexcept
{
    using std::swap;
    swap(role, other.role);
...
CreateConversionStmt::CreateConversionStmt([[maybe_unused]] CreateConversionStmt&& other) noexcept
...
void CreateConversionStmt::swap([[maybe_unused]] CreateConversionStmt& other) noexcept
{
    using std::swap;
...
CreateCastStmt::CreateCastStmt([[maybe_unused]] CreateCastStmt&& other) noexcept
...
void CreateCastStmt::swap([[maybe_unused]] CreateCastStmt& other) noexcept
{
    using std::swap;
...
{
    stream << "CreateCastStmt(";
    stream << "sourcetype="; stream << "ptr of other struct: " << (value.sourcetype == nullptr ? "nullptr" : "true");
    stream << ",targettype="; stream << "ptr of other struct: " << (value.targettype == nullptr ? "nullptr" : "true");
    stream << ",func="; stream << "ptr of other struct: " << (value.func == nullptr ? "nullptr" : "true");
...
CreateOpClassStmt::CreateOpClassStmt([[maybe_unused]] CreateOpClassStmt&& other) noexcept
...
void CreateOpClassStmt::swap([[maybe_unused]] CreateOpClassStmt& other) noexcept
{
    using std::swap;
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const CreateOpClassStmt& value)
{
    ...
    stream << ",datatype="; stream << "ptr of other struct: " << (value.datatype == nullptr ? "nullptr" : "true");
    {
        bool first = true;
        stream << ",items=[" << value.items.size() << "][";
        for (const auto& it : value.items)
...
CreateOpFamilyStmt::CreateOpFamilyStmt([[maybe_unused]] CreateOpFamilyStmt&& other) noexcept
    : opfamilyname(std::move(other.opfamilyname))
    , amname(std::move(other.amname))
{}
...
void CreateOpFamilyStmt::swap([[maybe_unused]] CreateOpFamilyStmt& other) noexcept
{
    using std::swap;
    swap(opfamilyname, other.opfamilyname);
    swap(amname, other.amname);
...
AlterOpFamilyStmt::AlterOpFamilyStmt([[maybe_unused]] AlterOpFamilyStmt&& other) noexcept
    : opfamilyname(std::move(other.opfamilyname))
    , amname(std::move(other.amname))
...
void AlterOpFamilyStmt::swap([[maybe_unused]] AlterOpFamilyStmt& other) noexcept
{
    using std::swap;
    swap(opfamilyname, other.opfamilyname);
    swap(amname, other.amname);
...
PrepareStmt::PrepareStmt([[maybe_unused]] PrepareStmt&& other) noexcept
    : name(std::move(other.name))
...
void PrepareStmt::swap([[maybe_unused]] PrepareStmt& other) noexcept
{
    using std::swap;
    swap(name, other.name);
...
ExecuteStmt::ExecuteStmt([[maybe_unused]] ExecuteStmt&& other) noexcept
    : name(std::move(other.name))
...
void ExecuteStmt::swap([[maybe_unused]] ExecuteStmt& other) noexcept
{
    using std::swap;
    swap(name, other.name);
...
DeallocateStmt::DeallocateStmt([[maybe_unused]] DeallocateStmt&& other) noexcept
    : name(std::move(other.name))
{}
...
void DeallocateStmt::swap([[maybe_unused]] DeallocateStmt& other) noexcept
{
    using std::swap;
    swap(name, other.name);
}
...
DeclareCursorStmt::DeclareCursorStmt([[maybe_unused]] DeclareCursorStmt&& other) noexcept
    : portalname(std::move(other.portalname))
    , options(std::exchange(other.options, (int32_t)0ll))
    , query(std::move(other.query))
{}
...
void DeclareCursorStmt::swap([[maybe_unused]] DeclareCursorStmt& other) noexcept
{
    using std::swap;
    swap(portalname, other.portalname);
    swap(options, other.options);
...
CreateTableSpaceStmt::CreateTableSpaceStmt([[maybe_unused]] CreateTableSpaceStmt&& other) noexcept
    : tablespacename(std::move(other.tablespacename))
...
void CreateTableSpaceStmt::swap([[maybe_unused]] CreateTableSpaceStmt& other) noexcept
{
    using std::swap;
    swap(tablespacename, other.tablespacename);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const CreateTableSpaceStmt& value)
{
    stream << "CreateTableSpaceStmt(";
    stream << "tablespacename="; stream << "\"" << value.tablespacename << "\"";
    stream << ",owner="; stream << "ptr of other struct: " << (value.owner == nullptr ? "nullptr" : "true");
    stream << ",location="; stream << "\"" << value.location << "\"";
    {
        bool first = true;
        stream << ",options=[" << value.options.size() << "][";
...
DropTableSpaceStmt::DropTableSpaceStmt([[maybe_unused]] DropTableSpaceStmt&& other) noexcept
    : tablespacename(std::move(other.tablespacename))
    , missing_ok(std::exchange(other.missing_ok, false))
{}
...
void DropTableSpaceStmt::swap([[maybe_unused]] DropTableSpaceStmt& other) noexcept
{
    using std::swap;
    swap(tablespacename, other.tablespacename);
    swap(missing_ok, other.missing_ok);
...
AlterObjectDependsStmt::AlterObjectDependsStmt([[maybe_unused]] AlterObjectDependsStmt&& other) noexcept
...
void AlterObjectDependsStmt::swap([[maybe_unused]] AlterObjectDependsStmt& other) noexcept
{
    using std::swap;
...
AlterObjectSchemaStmt::AlterObjectSchemaStmt([[maybe_unused]] AlterObjectSchemaStmt&& other) noexcept
    : object_type(std::move(other.object_type))
    , relation(std::exchange(other.relation, nullptr))
    , object(std::move(other.object))
...
void AlterObjectSchemaStmt::swap([[maybe_unused]] AlterObjectSchemaStmt& other) noexcept
{
    using std::swap;
    swap(object_type, other.object_type);
    swap(relation, other.relation);
...
AlterOwnerStmt::AlterOwnerStmt([[maybe_unused]] AlterOwnerStmt&& other) noexcept
    : object_type(std::move(other.object_type))
    , relation(std::exchange(other.relation, nullptr))
    , object(std::move(other.object))
    , newowner(std::exchange(other.newowner, nullptr))
...
void AlterOwnerStmt::swap([[maybe_unused]] AlterOwnerStmt& other) noexcept
{
    using std::swap;
    swap(object_type, other.object_type);
    swap(relation, other.relation);
...
AlterOperatorStmt::AlterOperatorStmt([[maybe_unused]] AlterOperatorStmt&& other) noexcept
...
void AlterOperatorStmt::swap([[maybe_unused]] AlterOperatorStmt& other) noexcept
{
    using std::swap;
...
{
    stream << "AlterOperatorStmt(";
    stream << "opername="; stream << "ptr of other struct: " << (value.opername == nullptr ? "nullptr" : "true");
    {
        bool first = true;
        stream << ",options=[" << value.options.size() << "][";
        for (const auto& it : value.options)
...
AlterTypeStmt::AlterTypeStmt([[maybe_unused]] AlterTypeStmt&& other) noexcept
    : type_name(std::move(other.type_name))
    , options(std::move(other.options))
{}
...
void AlterTypeStmt::swap([[maybe_unused]] AlterTypeStmt& other) noexcept
{
    using std::swap;
    swap(type_name, other.type_name);
    swap(options, other.options);
...
DropOwnedStmt::DropOwnedStmt([[maybe_unused]] DropOwnedStmt&& other) noexcept
    : roles(std::move(other.roles))
    , behavior(std::move(other.behavior))
{}
...
void DropOwnedStmt::swap([[maybe_unused]] DropOwnedStmt& other) noexcept
{
    using std::swap;
    swap(roles, other.roles);
    swap(behavior, other.behavior);
...
ReassignOwnedStmt::ReassignOwnedStmt([[maybe_unused]] ReassignOwnedStmt&& other) noexcept
    : roles(std::move(other.roles))
...
void ReassignOwnedStmt::swap([[maybe_unused]] ReassignOwnedStmt& other) noexcept
{
    using std::swap;
    swap(roles, other.roles);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const ReassignOwnedStmt& value)
{
    ...
    stream << ",newrole="; stream << "ptr of other struct: " << (value.newrole == nullptr ? "nullptr" : "true");
    stream << ")";
    return stream;
}
...
CompositeTypeStmt::CompositeTypeStmt([[maybe_unused]] CompositeTypeStmt&& other) noexcept
...
void CompositeTypeStmt::swap([[maybe_unused]] CompositeTypeStmt& other) noexcept
{
    using std::swap;
...
{
    stream << "CompositeTypeStmt(";
    stream << "typevar="; stream << "ptr of other struct: " << (value.typevar == nullptr ? "nullptr" : "true");
    {
        bool first = true;
...
CreateEnumStmt::CreateEnumStmt([[maybe_unused]] CreateEnumStmt&& other) noexcept
    : type_name(std::move(other.type_name))
...
void CreateEnumStmt::swap([[maybe_unused]] CreateEnumStmt& other) noexcept
{
    using std::swap;
    swap(type_name, other.type_name);
...
CreateRangeStmt::CreateRangeStmt([[maybe_unused]] CreateRangeStmt&& other) noexcept
    : type_name(std::move(other.type_name))
    , params(std::move(other.params))
{}
...
void CreateRangeStmt::swap([[maybe_unused]] CreateRangeStmt& other) noexcept
{
    using std::swap;
    swap(type_name, other.type_name);
    swap(params, other.params);
...
AlterEnumStmt::AlterEnumStmt([[maybe_unused]] AlterEnumStmt&& other) noexcept
    : type_name(std::move(other.type_name))
...
void AlterEnumStmt::swap([[maybe_unused]] AlterEnumStmt& other) noexcept
{
    using std::swap;
    swap(type_name, other.type_name);
...
AlterTSDictionaryStmt::AlterTSDictionaryStmt([[maybe_unused]] AlterTSDictionaryStmt&& other) noexcept
...
void AlterTSDictionaryStmt::swap([[maybe_unused]] AlterTSDictionaryStmt& other) noexcept
{
    using std::swap;
...
AlterTSConfigurationStmt::AlterTSConfigurationStmt([[maybe_unused]] AlterTSConfigurationStmt&& other) noexcept
    : kind(std::move(other.kind))
...
void AlterTSConfigurationStmt::swap([[maybe_unused]] AlterTSConfigurationStmt& other) noexcept
{
    using std::swap;
    swap(kind, other.kind);
...
CreateFdwStmt::CreateFdwStmt([[maybe_unused]] CreateFdwStmt&& other) noexcept
...
void CreateFdwStmt::swap([[maybe_unused]] CreateFdwStmt& other) noexcept
{
    using std::swap;
...
AlterFdwStmt::AlterFdwStmt([[maybe_unused]] AlterFdwStmt&& other) noexcept
    : fdwname(std::move(other.fdwname))
    , func_options(std::move(other.func_options))
    , options(std::move(other.options))
{}
...
void AlterFdwStmt::swap([[maybe_unused]] AlterFdwStmt& other) noexcept
{
    using std::swap;
    swap(fdwname, other.fdwname);
    swap(func_options, other.func_options);
...
CreateForeignServerStmt::CreateForeignServerStmt([[maybe_unused]] CreateForeignServerStmt&& other) noexcept
...
void CreateForeignServerStmt::swap([[maybe_unused]] CreateForeignServerStmt& other) noexcept
{
    using std::swap;
...
AlterForeignServerStmt::AlterForeignServerStmt([[maybe_unused]] AlterForeignServerStmt&& other) noexcept
    : servername(std::move(other.servername))
    , version(std::move(other.version))
    , options(std::move(other.options))
...
void AlterForeignServerStmt::swap([[maybe_unused]] AlterForeignServerStmt& other) noexcept
{
    using std::swap;
    swap(servername, other.servername);
    swap(version, other.version);
...
CreateUserMappingStmt::CreateUserMappingStmt([[maybe_unused]] CreateUserMappingStmt&& other) noexcept
...
void CreateUserMappingStmt::swap([[maybe_unused]] CreateUserMappingStmt& other) noexcept
{
    using std::swap;
...
{
    stream << "CreateUserMappingStmt(";
    stream << "user="; stream << "ptr of other struct: " << (value.user == nullptr ? "nullptr" : "true");
    stream << ",servername="; stream << "\"" << value.servername << "\"";
    stream << ",if_not_exists="; stream << (value.if_not_exists ? "true" : "false");
    {
        bool first = true;
...
AlterUserMappingStmt::AlterUserMappingStmt([[maybe_unused]] AlterUserMappingStmt&& other) noexcept
    : user(std::exchange(other.user, nullptr))
    , servername(std::move(other.servername))
    , options(std::move(other.options))
{}
...
void AlterUserMappingStmt::swap([[maybe_unused]] AlterUserMappingStmt& other) noexcept
{
    using std::swap;
    swap(user, other.user);
    swap(servername, other.servername);
...
DropUserMappingStmt::DropUserMappingStmt([[maybe_unused]] DropUserMappingStmt&& other) noexcept
    : user(std::exchange(other.user, nullptr))
    , servername(std::move(other.servername))
    , missing_ok(std::exchange(other.missing_ok, false))
{}
...
void DropUserMappingStmt::swap([[maybe_unused]] DropUserMappingStmt& other) noexcept
{
    using std::swap;
    swap(user, other.user);
    swap(servername, other.servername);
...
AlterTableSpaceOptionsStmt::AlterTableSpaceOptionsStmt([[maybe_unused]] AlterTableSpaceOptionsStmt&& other) noexcept
    : tablespacename(std::move(other.tablespacename))
    , options(std::move(other.options))
...
void AlterTableSpaceOptionsStmt::swap([[maybe_unused]] AlterTableSpaceOptionsStmt& other) noexcept
{
    using std::swap;
    swap(tablespacename, other.tablespacename);
    swap(options, other.options);
...
AlterTableMoveAllStmt::AlterTableMoveAllStmt([[maybe_unused]] AlterTableMoveAllStmt&& other) noexcept
...
void AlterTableMoveAllStmt::swap([[maybe_unused]] AlterTableMoveAllStmt& other) noexcept
{
    using std::swap;
...
SecLabelStmt::SecLabelStmt([[maybe_unused]] SecLabelStmt&& other) noexcept
    : objtype(std::move(other.objtype))
    , object(std::move(other.object))
...
void SecLabelStmt::swap([[maybe_unused]] SecLabelStmt& other) noexcept
{
    using std::swap;
    swap(objtype, other.objtype);
    swap(object, other.object);
...
CreateForeignTableStmt::CreateForeignTableStmt([[maybe_unused]] CreateForeignTableStmt&& other) noexcept
...
void CreateForeignTableStmt::swap([[maybe_unused]] CreateForeignTableStmt& other) noexcept
{
    using std::swap;
...
ImportForeignSchemaStmt::ImportForeignSchemaStmt([[maybe_unused]] ImportForeignSchemaStmt&& other) noexcept
...
void ImportForeignSchemaStmt::swap([[maybe_unused]] ImportForeignSchemaStmt& other) noexcept
{
    using std::swap;
...
CreateExtensionStmt::CreateExtensionStmt([[maybe_unused]] CreateExtensionStmt&& other) noexcept
    : extname(std::move(other.extname))
    , if_not_exists(std::exchange(other.if_not_exists, false))
    , options(std::move(other.options))
{}
...
void CreateExtensionStmt::swap([[maybe_unused]] CreateExtensionStmt& other) noexcept
{
    using std::swap;
    swap(extname, other.extname);
    swap(if_not_exists, other.if_not_exists);
...
AlterExtensionStmt::AlterExtensionStmt([[maybe_unused]] AlterExtensionStmt&& other) noexcept
    : extname(std::move(other.extname))
    , options(std::move(other.options))
{}
...
void AlterExtensionStmt::swap([[maybe_unused]] AlterExtensionStmt& other) noexcept
{
    using std::swap;
    swap(extname, other.extname);
    swap(options, other.options);
...
AlterExtensionContentsStmt::AlterExtensionContentsStmt([[maybe_unused]] AlterExtensionContentsStmt&& other) noexcept
    : extname(std::move(other.extname))
    , action(std::exchange(other.action, (int32_t)0ll))
    , objtype(std::move(other.objtype))
    , object(std::move(other.object))
...
void AlterExtensionContentsStmt::swap([[maybe_unused]] AlterExtensionContentsStmt& other) noexcept
{
    using std::swap;
    swap(extname, other.extname);
    swap(action, other.action);
...
CreateEventTrigStmt::CreateEventTrigStmt([[maybe_unused]] CreateEventTrigStmt&& other) noexcept
    : trigname(std::move(other.trigname))
...
void CreateEventTrigStmt::swap([[maybe_unused]] CreateEventTrigStmt& other) noexcept
{
    using std::swap;
    swap(trigname, other.trigname);
...
AlterEventTrigStmt::AlterEventTrigStmt([[maybe_unused]] AlterEventTrigStmt&& other) noexcept
    : trigname(std::move(other.trigname))
...
void AlterEventTrigStmt::swap([[maybe_unused]] AlterEventTrigStmt& other) noexcept
{
    using std::swap;
    swap(trigname, other.trigname);
...
RefreshMatViewStmt::RefreshMatViewStmt([[maybe_unused]] RefreshMatViewStmt&& other) noexcept
    : concurrent(std::exchange(other.concurrent, false))
    , skip_data(std::exchange(other.skip_data, false))
    , relation(std::exchange(other.relation, nullptr))
{}
...
void RefreshMatViewStmt::swap([[maybe_unused]] RefreshMatViewStmt& other) noexcept
{
    using std::swap;
    swap(concurrent, other.concurrent);
    swap(skip_data, other.skip_data);
...
ReplicaIdentityStmt::ReplicaIdentityStmt([[maybe_unused]] ReplicaIdentityStmt&& other) noexcept
...
void ReplicaIdentityStmt::swap([[maybe_unused]] ReplicaIdentityStmt& other) noexcept
{
    using std::swap;
...
AlterSystemStmt::AlterSystemStmt([[maybe_unused]] AlterSystemStmt&& other) noexcept
    : setstmt(std::exchange(other.setstmt, nullptr))
{}
...
void AlterSystemStmt::swap([[maybe_unused]] AlterSystemStmt& other) noexcept
{
    using std::swap;
    swap(setstmt, other.setstmt);
}
...
CreatePolicyStmt::CreatePolicyStmt([[maybe_unused]] CreatePolicyStmt&& other) noexcept
...
void CreatePolicyStmt::swap([[maybe_unused]] CreatePolicyStmt& other) noexcept
{
    using std::swap;
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const CreatePolicyStmt& value)
{
    ...
    stream << ",table="; stream << "ptr of other struct: " << (value.table == nullptr ? "nullptr" : "true");
...
AlterPolicyStmt::AlterPolicyStmt([[maybe_unused]] AlterPolicyStmt&& other) noexcept
    : policy_name(std::move(other.policy_name))
    , table(std::exchange(other.table, nullptr))
    , roles(std::move(other.roles))
    , qual(std::move(other.qual))
...
void AlterPolicyStmt::swap([[maybe_unused]] AlterPolicyStmt& other) noexcept
{
    using std::swap;
    swap(policy_name, other.policy_name);
    swap(table, other.table);
...
CreateTransformStmt::CreateTransformStmt([[maybe_unused]] CreateTransformStmt&& other) noexcept
    : replace(std::exchange(other.replace, false))
    , type_name(std::exchange(other.type_name, nullptr))
...
void CreateTransformStmt::swap([[maybe_unused]] CreateTransformStmt& other) noexcept
{
    using std::swap;
    swap(replace, other.replace);
    swap(type_name, other.type_name);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const CreateTransformStmt& value)
{
    ...
    stream << ",fromsql="; stream << "ptr of other struct: " << (value.fromsql == nullptr ? "nullptr" : "true");
    stream << ",tosql="; stream << "ptr of other struct: " << (value.tosql == nullptr ? "nullptr" : "true");
    stream << ")";
    return stream;
}
...
CreateAmStmt::CreateAmStmt([[maybe_unused]] CreateAmStmt&& other) noexcept
    : amname(std::move(other.amname))
...
void CreateAmStmt::swap([[maybe_unused]] CreateAmStmt& other) noexcept
{
    using std::swap;
    swap(amname, other.amname);
...
CreatePublicationStmt::CreatePublicationStmt([[maybe_unused]] CreatePublicationStmt&& other) noexcept
...
void CreatePublicationStmt::swap([[maybe_unused]] CreatePublicationStmt& other) noexcept
{
    using std::swap;
...
AlterPublicationStmt::AlterPublicationStmt([[maybe_unused]] AlterPublicationStmt&& other) noexcept
    : pubname(std::move(other.pubname))
    , options(std::move(other.options))
    , tables(std::move(other.tables))
    , for_all_tables(std::exchange(other.for_all_tables, false))
...
void AlterPublicationStmt::swap([[maybe_unused]] AlterPublicationStmt& other) noexcept
{
    using std::swap;
    swap(pubname, other.pubname);
    swap(options, other.options);
...
CreateSubscriptionStmt::CreateSubscriptionStmt([[maybe_unused]] CreateSubscriptionStmt&& other) noexcept
    : subname(std::move(other.subname))
...
void CreateSubscriptionStmt::swap([[maybe_unused]] CreateSubscriptionStmt& other) noexcept
{
    using std::swap;
    swap(subname, other.subname);
...
AlterSubscriptionStmt::AlterSubscriptionStmt([[maybe_unused]] AlterSubscriptionStmt&& other) noexcept
    : kind(std::move(other.kind))
    , subname(std::move(other.subname))
    , conninfo(std::move(other.conninfo))
    , publication(std::move(other.publication))
...
void AlterSubscriptionStmt::swap([[maybe_unused]] AlterSubscriptionStmt& other) noexcept
{
    using std::swap;
    swap(kind, other.kind);
    swap(subname, other.subname);
...
DropSubscriptionStmt::DropSubscriptionStmt([[maybe_unused]] DropSubscriptionStmt&& other) noexcept
    : subname(std::move(other.subname))
    , missing_ok(std::exchange(other.missing_ok, false))
    , behavior(std::move(other.behavior))
{}
...
void DropSubscriptionStmt::swap([[maybe_unused]] DropSubscriptionStmt& other) noexcept
{
    using std::swap;
    swap(subname, other.subname);
    swap(missing_ok, other.missing_ok);
...
CreateStatsStmt::CreateStatsStmt([[maybe_unused]] CreateStatsStmt&& other) noexcept
    : defnames(std::move(other.defnames))
...
void CreateStatsStmt::swap([[maybe_unused]] CreateStatsStmt& other) noexcept
{
    using std::swap;
    swap(defnames, other.defnames);
...
AlterCollationStmt::AlterCollationStmt([[maybe_unused]] AlterCollationStmt&& other) noexcept
...
void AlterCollationStmt::swap([[maybe_unused]] AlterCollationStmt& other) noexcept
{
    using std::swap;
...
CallStmt::CallStmt([[maybe_unused]] CallStmt&& other) noexcept
...
void CallStmt::swap([[maybe_unused]] CallStmt& other) noexcept
{
    using std::swap;
...
{
    stream << "CallStmt(";
    stream << "funccall="; stream << "ptr of other struct: " << (value.funccall == nullptr ? "nullptr" : "true");
    stream << ",funcexpr="; stream << "ptr of other struct: " << (value.funcexpr == nullptr ? "nullptr" : "true");
    stream << ")";
    return stream;
}
...
AlterStatsStmt::AlterStatsStmt([[maybe_unused]] AlterStatsStmt&& other) noexcept
    : defnames(std::move(other.defnames))
...
void AlterStatsStmt::swap([[maybe_unused]] AlterStatsStmt& other) noexcept
{
    using std::swap;
    swap(defnames, other.defnames);
...
A_Expr::A_Expr([[maybe_unused]] A_Expr&& other) noexcept
    : kind(std::move(other.kind))
    , name(std::move(other.name))
...
void A_Expr::swap([[maybe_unused]] A_Expr& other) noexcept
{
    using std::swap;
    swap(kind, other.kind);
    swap(name, other.name);
...
ColumnRef::ColumnRef([[maybe_unused]] ColumnRef&& other) noexcept
...
void ColumnRef::swap([[maybe_unused]] ColumnRef& other) noexcept
{
    using std::swap;
...
ParamRef::ParamRef([[maybe_unused]] ParamRef&& other) noexcept
...
void ParamRef::swap([[maybe_unused]] ParamRef& other) noexcept
{
    using std::swap;
...
A_Const::A_Const([[maybe_unused]] A_Const&& other) noexcept
...
void A_Const::swap([[maybe_unused]] A_Const& other) noexcept
{
    using std::swap;
    swap(val, other.val);
    swap(location, other.location);
...
FuncCall::FuncCall([[maybe_unused]] FuncCall&& other) noexcept
    : funcname(std::move(other.funcname))
    , args(std::move(other.args))
...
void FuncCall::swap([[maybe_unused]] FuncCall& other) noexcept
{
    using std::swap;
    swap(funcname, other.funcname);
    swap(args, other.args);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const FuncCall& value)
{
    ...
    stream << ",over="; stream << "ptr of other struct: " << (value.over == nullptr ? "nullptr" : "true");
    stream << ",location="; stream << value.location;
    stream << ")";
    return stream;
}
...
A_Star::A_Star([[maybe_unused]] A_Star&& other) noexcept
{}
...
void A_Star::swap([[maybe_unused]] A_Star& other) noexcept
{
    using std::swap;
}
...
A_Indices::A_Indices([[maybe_unused]] A_Indices&& other) noexcept
...
void A_Indices::swap([[maybe_unused]] A_Indices& other) noexcept
{
    using std::swap;
...
A_Indirection::A_Indirection([[maybe_unused]] A_Indirection&& other) noexcept
    : arg(std::move(other.arg))
...
void A_Indirection::swap([[maybe_unused]] A_Indirection& other) noexcept
{
    using std::swap;
    swap(arg, other.arg);
...
A_ArrayExpr::A_ArrayExpr([[maybe_unused]] A_ArrayExpr&& other) noexcept
    : elements(std::move(other.elements))
    , location(std::exchange(other.location, (int32_t)0ll))
{}
...
void A_ArrayExpr::swap([[maybe_unused]] A_ArrayExpr& other) noexcept
{
    using std::swap;
    swap(elements, other.elements);
    swap(location, other.location);
...
ResTarget::ResTarget([[maybe_unused]] ResTarget&& other) noexcept
    : name(std::move(other.name))
    , indirection(std::move(other.indirection))
    , val(std::move(other.val))
    , location(std::exchange(other.location, (int32_t)0ll))
...
void ResTarget::swap([[maybe_unused]] ResTarget& other) noexcept
{
    using std::swap;
    swap(name, other.name);
    swap(indirection, other.indirection);
...
MultiAssignRef::MultiAssignRef([[maybe_unused]] MultiAssignRef&& other) noexcept
...
void MultiAssignRef::swap([[maybe_unused]] MultiAssignRef& other) noexcept
{
    using std::swap;
...
TypeCast::TypeCast([[maybe_unused]] TypeCast&& other) noexcept
    : arg(std::move(other.arg))
    , type_name(std::exchange(other.type_name, nullptr))
    , location(std::exchange(other.location, (int32_t)0ll))
{}
...
void TypeCast::swap([[maybe_unused]] TypeCast& other) noexcept
{
    using std::swap;
    swap(arg, other.arg);
    swap(type_name, other.type_name);
...
CollateClause::CollateClause([[maybe_unused]] CollateClause&& other) noexcept
    : arg(std::move(other.arg))
    , collname(std::move(other.collname))
    , location(std::exchange(other.location, (int32_t)0ll))
{}
...
void CollateClause::swap([[maybe_unused]] CollateClause& other) noexcept
{
    using std::swap;
    swap(arg, other.arg);
    swap(collname, other.collname);
...
SortBy::SortBy([[maybe_unused]] SortBy&& other) noexcept
...
void SortBy::swap([[maybe_unused]] SortBy& other) noexcept
{
    using std::swap;
...
WindowDef::WindowDef([[maybe_unused]] WindowDef&& other) noexcept
    : name(std::move(other.name))
...
void WindowDef::swap([[maybe_unused]] WindowDef& other) noexcept
{
    using std::swap;
    swap(name, other.name);
...
RangeSubselect::RangeSubselect([[maybe_unused]] RangeSubselect&& other) noexcept
...
void RangeSubselect::swap([[maybe_unused]] RangeSubselect& other) noexcept
{
    using std::swap;
...
RangeFunction::RangeFunction([[maybe_unused]] RangeFunction&& other) noexcept
    : lateral(std::exchange(other.lateral, false))
...
void RangeFunction::swap([[maybe_unused]] RangeFunction& other) noexcept
{
    using std::swap;
    swap(lateral, other.lateral);
...
RangeTableSample::RangeTableSample([[maybe_unused]] RangeTableSample&& other) noexcept
...
void RangeTableSample::swap([[maybe_unused]] RangeTableSample& other) noexcept
{
    using std::swap;
    swap(relation, other.relation);
...
RangeTableFunc::RangeTableFunc([[maybe_unused]] RangeTableFunc&& other) noexcept
    : lateral(std::exchange(other.lateral, false))
    , docexpr(std::move(other.docexpr))
    , rowexpr(std::move(other.rowexpr))
...
void RangeTableFunc::swap([[maybe_unused]] RangeTableFunc& other) noexcept
{
    using std::swap;
    swap(lateral, other.lateral);
    swap(docexpr, other.docexpr);
...
RangeTableFuncCol::RangeTableFuncCol([[maybe_unused]] RangeTableFuncCol&& other) noexcept
...
void RangeTableFuncCol::swap([[maybe_unused]] RangeTableFuncCol& other) noexcept
{
    using std::swap;
...
TypeName::TypeName([[maybe_unused]] TypeName&& other) noexcept
...
void TypeName::swap([[maybe_unused]] TypeName& other) noexcept
{
    using std::swap;
...
ColumnDef::ColumnDef([[maybe_unused]] ColumnDef&& other) noexcept
    : colname(std::move(other.colname))
    , type_name(std::exchange(other.type_name, nullptr))
...
void ColumnDef::swap([[maybe_unused]] ColumnDef& other) noexcept
{
    using std::swap;
    swap(colname, other.colname);
    swap(type_name, other.type_name);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const ColumnDef& value)
{
    ...
    stream << ",identity_sequence="; stream << "ptr of other struct: " << (value.identity_sequence == nullptr ? "nullptr" : "true");
...
IndexElem::IndexElem([[maybe_unused]] IndexElem&& other) noexcept
    : name(std::move(other.name))
    , expr(std::move(other.expr))
...
void IndexElem::swap([[maybe_unused]] IndexElem& other) noexcept
{
    using std::swap;
    swap(name, other.name);
    swap(expr, other.expr);
...
Constraint::Constraint([[maybe_unused]] Constraint&& other) noexcept
...
void Constraint::swap([[maybe_unused]] Constraint& other) noexcept
{
    using std::swap;
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const Constraint& value)
{
    ...
    stream << ",access_method="; stream << "\"" << value.access_method << "\"";
    stream << ",where_clause="; stream << value.where_clause;
    stream << ",pktable="; stream << "ptr of other struct: " << (value.pktable == nullptr ? "nullptr" : "true");
    {
        bool first = true;
...
DefElem::DefElem([[maybe_unused]] DefElem&& other) noexcept
...
void DefElem::swap([[maybe_unused]] DefElem& other) noexcept
{
    using std::swap;
...
RangeTblEntry::RangeTblEntry([[maybe_unused]] RangeTblEntry&& other) noexcept
...
void RangeTblEntry::swap([[maybe_unused]] RangeTblEntry& other) noexcept
{
    using std::swap;
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const RangeTblEntry& value)
{
    ...
    stream << ",tablesample="; stream << "ptr of other struct: " << (value.tablesample == nullptr ? "nullptr" : "true");
    stream << ",subquery="; stream << "ptr of other struct: " << (value.subquery == nullptr ? "nullptr" : "true");
    ...
    stream << ",tablefunc="; stream << "ptr of other struct: " << (value.tablefunc == nullptr ? "nullptr" : "true");
    {
        bool first = true;
        stream << ",values_lists=[" << value.values_lists.size() << "][";
        for (const auto& it : value.values_lists)
    ...
    stream << ",alias="; stream << "ptr of other struct: " << (value.alias == nullptr ? "nullptr" : "true");
    stream << ",eref="; stream << "ptr of other struct: " << (value.eref == nullptr ? "nullptr" : "true");
    stream << ",lateral="; stream << (value.lateral ? "true" : "false");
    stream << ",inh="; stream << (value.inh ? "true" : "false");
...
RangeTblFunction::RangeTblFunction([[maybe_unused]] RangeTblFunction&& other) noexcept
...
void RangeTblFunction::swap([[maybe_unused]] RangeTblFunction& other) noexcept
{
    using std::swap;
    swap(funcexpr, other.funcexpr);
...
TableSampleClause::TableSampleClause([[maybe_unused]] TableSampleClause&& other) noexcept
...
void TableSampleClause::swap([[maybe_unused]] TableSampleClause& other) noexcept
{
    using std::swap;
...
WithCheckOption::WithCheckOption([[maybe_unused]] WithCheckOption&& other) noexcept
    : kind(std::move(other.kind))
    , relname(std::move(other.relname))
...
void WithCheckOption::swap([[maybe_unused]] WithCheckOption& other) noexcept
{
    using std::swap;
    swap(kind, other.kind);
    swap(relname, other.relname);
...
SortGroupClause::SortGroupClause([[maybe_unused]] SortGroupClause&& other) noexcept
...
void SortGroupClause::swap([[maybe_unused]] SortGroupClause& other) noexcept
{
    using std::swap;
...
GroupingSet::GroupingSet([[maybe_unused]] GroupingSet&& other) noexcept
    : kind(std::move(other.kind))
...
void GroupingSet::swap([[maybe_unused]] GroupingSet& other) noexcept
{
    using std::swap;
    swap(kind, other.kind);
...
WindowClause::WindowClause([[maybe_unused]] WindowClause&& other) noexcept
    : name(std::move(other.name))
    , refname(std::move(other.refname))
    , partition_clause(std::move(other.partition_clause))
    , order_clause(std::move(other.order_clause))
...
void WindowClause::swap([[maybe_unused]] WindowClause& other) noexcept
{
    using std::swap;
    swap(name, other.name);
    swap(refname, other.refname);
...
ObjectWithArgs::ObjectWithArgs([[maybe_unused]] ObjectWithArgs&& other) noexcept
...
void ObjectWithArgs::swap([[maybe_unused]] ObjectWithArgs& other) noexcept
{
    using std::swap;
...
AccessPriv::AccessPriv([[maybe_unused]] AccessPriv&& other) noexcept
...
void AccessPriv::swap([[maybe_unused]] AccessPriv& other) noexcept
{
    using std::swap;
...
CreateOpClassItem::CreateOpClassItem([[maybe_unused]] CreateOpClassItem&& other) noexcept
...
void CreateOpClassItem::swap([[maybe_unused]] CreateOpClassItem& other) noexcept
{
    using std::swap;
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const CreateOpClassItem& value)
{
    ...
    stream << ",name="; stream << "ptr of other struct: " << (value.name == nullptr ? "nullptr" : "true");
    stream << ",number="; stream << value.number;
    {
        bool first = true;
    ...
    stream << ",storedtype="; stream << "ptr of other struct: " << (value.storedtype == nullptr ? "nullptr" : "true");
    stream << ")";
    return stream;
}
...
TableLikeClause::TableLikeClause([[maybe_unused]] TableLikeClause&& other) noexcept
    : relation(std::exchange(other.relation, nullptr))
...
void TableLikeClause::swap([[maybe_unused]] TableLikeClause& other) noexcept
{
    using std::swap;
    swap(relation, other.relation);
    swap(options, other.options);
...
FunctionParameter::FunctionParameter([[maybe_unused]] FunctionParameter&& other) noexcept
    : name(std::move(other.name))
...
void FunctionParameter::swap([[maybe_unused]] FunctionParameter& other) noexcept
{
    using std::swap;
    swap(name, other.name);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const FunctionParameter& value)
{
    stream << "FunctionParameter(";
    stream << "name="; stream << "\"" << value.name << "\"";
    stream << ",arg_type="; stream << "ptr of other struct: " << (value.arg_type == nullptr ? "nullptr" : "true");
    stream << ",mode="; stream << value.mode;
...
LockingClause::LockingClause([[maybe_unused]] LockingClause&& other) noexcept
...
void LockingClause::swap([[maybe_unused]] LockingClause& other) noexcept
{
    using std::swap;
...
RowMarkClause::RowMarkClause([[maybe_unused]] RowMarkClause&& other) noexcept
...
void RowMarkClause::swap([[maybe_unused]] RowMarkClause& other) noexcept
{
    using std::swap;
    swap(rti, other.rti);
    swap(strength, other.strength);
...
XmlSerialize::XmlSerialize([[maybe_unused]] XmlSerialize&& other) noexcept
    : xmloption(std::move(other.xmloption))
    , expr(std::move(other.expr))
    , type_name(std::exchange(other.type_name, nullptr))
    , location(std::exchange(other.location, (int32_t)0ll))
...
void XmlSerialize::swap([[maybe_unused]] XmlSerialize& other) noexcept
{
    using std::swap;
    swap(xmloption, other.xmloption);
    swap(expr, other.expr);
...
WithClause::WithClause([[maybe_unused]] WithClause&& other) noexcept
...
void WithClause::swap([[maybe_unused]] WithClause& other) noexcept
{
    using std::swap;
...
InferClause::InferClause([[maybe_unused]] InferClause&& other) noexcept
...
void InferClause::swap([[maybe_unused]] InferClause& other) noexcept
{
    using std::swap;
...
OnConflictClause::OnConflictClause([[maybe_unused]] OnConflictClause&& other) noexcept
    : action(std::move(other.action))
...
void OnConflictClause::swap([[maybe_unused]] OnConflictClause& other) noexcept
{
    using std::swap;
    swap(action, other.action);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const OnConflictClause& value)
{
    stream << "OnConflictClause(";
    stream << "action="; stream << value.action;
    stream << ",infer="; stream << "ptr of other struct: " << (value.infer == nullptr ? "nullptr" : "true");
    {
        bool first = true;
        stream << ",target_list=[" << value.target_list.size() << "][";
        for (const auto& it : value.target_list)
...
CommonTableExpr::CommonTableExpr([[maybe_unused]] CommonTableExpr&& other) noexcept
    : ctename(std::move(other.ctename))
...
void CommonTableExpr::swap([[maybe_unused]] CommonTableExpr& other) noexcept
{
    using std::swap;
    swap(ctename, other.ctename);
...
RoleSpec::RoleSpec([[maybe_unused]] RoleSpec&& other) noexcept
...
void RoleSpec::swap([[maybe_unused]] RoleSpec& other) noexcept
{
    using std::swap;
...
TriggerTransition::TriggerTransition([[maybe_unused]] TriggerTransition&& other) noexcept
    : name(std::move(other.name))
...
void TriggerTransition::swap([[maybe_unused]] TriggerTransition& other) noexcept
{
    using std::swap;
    swap(name, other.name);
...
PartitionElem::PartitionElem([[maybe_unused]] PartitionElem&& other) noexcept
    : name(std::move(other.name))
    , expr(std::move(other.expr))
    , collation(std::move(other.collation))
    , opclass(std::move(other.opclass))
...
void PartitionElem::swap([[maybe_unused]] PartitionElem& other) noexcept
{
    using std::swap;
    swap(name, other.name);
    swap(expr, other.expr);
...
PartitionSpec::PartitionSpec([[maybe_unused]] PartitionSpec&& other) noexcept
...
void PartitionSpec::swap([[maybe_unused]] PartitionSpec& other) noexcept
{
    using std::swap;
...
PartitionBoundSpec::PartitionBoundSpec([[maybe_unused]] PartitionBoundSpec&& other) noexcept
    : strategy(std::move(other.strategy))
    , is_default(std::exchange(other.is_default, false))
...
void PartitionBoundSpec::swap([[maybe_unused]] PartitionBoundSpec& other) noexcept
{
    using std::swap;
    swap(strategy, other.strategy);
    swap(is_default, other.is_default);
...
PartitionRangeDatum::PartitionRangeDatum([[maybe_unused]] PartitionRangeDatum&& other) noexcept
    : kind(std::move(other.kind))
...
void PartitionRangeDatum::swap([[maybe_unused]] PartitionRangeDatum& other) noexcept
{
    using std::swap;
    swap(kind, other.kind);
...
PartitionCmd::PartitionCmd([[maybe_unused]] PartitionCmd&& other) noexcept
    : name(std::exchange(other.name, nullptr))
...
void PartitionCmd::swap([[maybe_unused]] PartitionCmd& other) noexcept
{
    using std::swap;
    swap(name, other.name);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const PartitionCmd& value)
{
    stream << "PartitionCmd(";
    stream << "name="; stream << "ptr of other struct: " << (value.name == nullptr ? "nullptr" : "true");
    stream << ",bound="; stream << "ptr of other struct: " << (value.bound == nullptr ? "nullptr" : "true");
    stream << ")";
    return stream;
}
...
VacuumRelation::VacuumRelation([[maybe_unused]] VacuumRelation&& other) noexcept
    : relation(std::exchange(other.relation, nullptr))
...
void VacuumRelation::swap([[maybe_unused]] VacuumRelation& other) noexcept
{
    using std::swap;
    swap(relation, other.relation);
    swap(oid, other.oid);
...
InlineCodeBlock::InlineCodeBlock([[maybe_unused]] InlineCodeBlock&& other) noexcept
...
void InlineCodeBlock::swap([[maybe_unused]] InlineCodeBlock& other) noexcept
{
    using std::swap;
...
CallContext::CallContext([[maybe_unused]] CallContext&& other) noexcept
    : atomic(std::exchange(other.atomic, false))
{}
...
void CallContext::swap([[maybe_unused]] CallContext& other) noexcept
{
    using std::swap;
    swap(atomic, other.atomic);
}
...
ScanToken::ScanToken([[maybe_unused]] ScanToken&& other) noexcept
...
void ScanToken::swap([[maybe_unused]] ScanToken& other) noexcept
{
    using std::swap;
...
ParseResult::ParseResult([[maybe_unused]] ParseResult&& other) noexcept
...
void ParseResult::swap([[maybe_unused]] ParseResult& other) noexcept
{
    using std::swap;
    swap(version, other.version);
...
ScanResult::ScanResult([[maybe_unused]] ScanResult&& other) noexcept
    : version(std::exchange(other.version, (int32_t)0ll))
...
void ScanResult::swap([[maybe_unused]] ScanResult& other) noexcept
{
    using std::swap;
    swap(version, other.version);
